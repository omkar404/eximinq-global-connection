      ...
      <div class="container mx-auto px-4 text-center">
        ...
        <div class="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          <div class="bg-white rounded-xl shadow-lg overflow-hidden border border-slate-200">
            ...
            <div class="p-8">
              ...
              <ul class="text-left space-y-3 mb-8 text-sm text-slate-600">
                <li class="flex gap-2">
                  <i class="fas fa-check text-green-500"></i> ICEGATE ID
                  Creation
                </li>
                <li class="flex gap-2">
                  <i class="fas fa-check text-green-500"></i> Profile Validation
                </li>
                <li class="flex gap-2">
                  <i class="fas fa-check text-green-500"></i> Digital Signature
                  Mapping
                </li>
                <li class="flex gap-2">
                  <i class="fas fa-check text-green-500"></i> Common Signer
                  Utility Setup
                </li>
              </ul>
              <a
                href="#contact"
                class="block w-full bg-brand-600 text-white font-bold py-3 rounded-lg hover:bg-brand-700 transition"
              >
                Get Started
              </a>
            </div>
          ...
          <div class="bg-white rounded-xl shadow-lg overflow-hidden border border-slate-200 relative">
            <div class="absolute top-0 right-0 bg-accent-500 text-brand-900 text-xs font-bold px-3 py-1 rounded-bl-lg">
              RECOMMENDED
            </div>
            ...
            <div class="p-8">
              ...
              <ul class="text-left space-y-3 mb-8 text-sm text-slate-600">
                <li class="flex gap-2">
                  <i class="fas fa-check text-green-500"></i> Bank Letter
                  Drafting
                </li>
                <li class="flex gap-2">
                  <i class="fas fa-check text-green-500"></i> e-Sanchit Upload
                  (IRN Generation)
                </li>
                <li class="flex gap-2">
                  <i class="fas fa-check text-green-500"></i> Online Submission
                  to Customs
                </li>
                <li class="flex gap-2">
                  <i class="fas fa-check text-green-500"></i> Query Resolution
                  Support
                </li>
              </ul>
              <a
