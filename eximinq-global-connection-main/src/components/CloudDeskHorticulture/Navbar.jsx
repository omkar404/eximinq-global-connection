      ...
      <nav className="container mx-auto px-4 py-4 flex justify-center items-center">
        ...
        <div className="hidden md:flex gap-10 font-bold text-sm text-slate-700">
          <a href="#home" class="hover:text-brand-600 transition">Home</a>
                ...
                <a href="#schemes" class="hover:text-brand-600 transition">NHB Schemes</a>
                <a href="#apeda" class="hover:text-brand-600 transition">APEDA & GAP</a>
      ...
      {open && (
        <div className="md:hidden bg-white border-t border-slate-100 p-4 text-center font-bold text-slate-700">
          <a href="#home" class="hover:text-brand-600 transition">Home</a>
            ...
            <a href="#schemes" class="block py-2 text-slate-600">NHB Schemes</a>
            <a href="#apeda" class="block py-2 text-slate-600">APEDA & GAP</a>
            <a href="#contact" class="block py-2 text-brand-600 font-bold">Get Subsidy</a>
          <a 
            href="#contact"
