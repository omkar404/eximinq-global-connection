      ...
      {open && (
        <div className="md:hidden bg-white border-t border-slate-100 p-4 text-center font-bold text-slate-700">
          <a href="#home" class="hover:text-brand-600 transition">Home</a>
            ...
            <a href="#rates" class="block py-2 text-slate-600">Rates & Eligibility</a>
            <a href="#issues" class="block py-2 text-slate-600">Common Issues</a>
            <a href="#contact" class="block py-2 text-brand-600 font-bold">Verify Benefit</a>
