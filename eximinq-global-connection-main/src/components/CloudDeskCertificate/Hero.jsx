      ...
      <div className="container mx-auto px-4 grid md:grid-cols-2 gap-12 items-center">
        ...
        <div>
          ...
          <p class="text-lg text-slate-200 mb-8 leading-relaxed">
            Enable your international buyers to claim{" "}
            <strong>Duty Concessions</strong>. We facilitate digital issuance of
            Preferential (FTA/PTA) and Non-Preferential CoO via the DGFT Common
            Digital Platform.
          </p>
          <div class="flex flex-col sm:flex-row gap-4">
            ...
            <a
              href="#agreements"
              class="bg-transparent border border-white hover:bg-white hover:text-brand-900 text-center font-semibold py-3 px-8 rounded-lg transition"
            >
              Check FTA List
            </a>
          </div>
