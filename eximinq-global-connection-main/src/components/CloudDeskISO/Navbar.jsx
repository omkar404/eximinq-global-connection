  ...
  Get Certified
      ...
      {open && (
        <div className="md:hidden bg-white border-t border-slate-100 p-4 text-center font-bold text-slate-700">
          <a href="#home" class="hover:text-brand-600 transition">Home</a>
            <a href="#about" class="block py-2 text-slate-600">Why ISO?</a>
            <a href="#standards" class="block py-2 text-slate-600">Standards</a>
            <a href="#iaf" class="block py-2 text-slate-600">IAF vs Non-IAF</a>
            <a href="#contact" class="block py-2 text-brand-600 font-bold">Get Certified</a>
