...
<div>
                ...
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-6">
                    <span className="text-transparent bg-clip-text bg-gradient-to-r from-accent-400 to-accent-400">Factory Stuffing </span > 
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                    ...
                    <a href="#methods" className="bg-transparent border border-white hover:bg-white hover:text-brand-900 text-center font-semibold py-3 px-8 rounded-lg transition">
                        Self Sealing
                    </a>
                </div>
            </div>
