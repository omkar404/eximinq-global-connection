      ...
      <div className="container mx-auto px-4 grid md:grid-cols-2 gap-12 items-center">
        ...
        <div>
          ...
          <p className="text-lg text-slate-200 mb-8 leading-relaxed">
            Avoid Demurrage and Detention. We ensure 100% compliant
            classification of HS Codes and timely filing of your Import
            Declarations at all major Indian ports.
          </p>

          <div className="flex flex-col sm:flex-row gap-4">
            <button
              onClick={() => setShowEnrollModal({ open: true, type: "Hero_Bill_of_Entry" })}
        ...
        {/* FORM SECTION */}
        <QuickForm formType="Get Quote for Clearance" />
      </div>
    </section>
  );
};
