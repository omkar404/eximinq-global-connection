...
<div>
                ...
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-6">
                    FSSAI Licensing & <span className="text-transparent bg-clip-text bg-gradient-to-r from-accent-400 to-accent-600">Import Clearance</span>
                </h1>
