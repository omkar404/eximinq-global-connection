const defenceeximLicenseRoutes = require("../models/defenceeximLicenseRoutes.model");
    ...
    html: `
      <div style="font-family:Arial;">
        ...
        <table border="1" cellpadding="6" style="border-collapse:collapse;">
          ...
          ${itemDescription ? `<tr><td><b>Product Type</b></td><td>${itemDescription}</td></tr>` : ""}
          ${endUse ? `<tr><td><b>Port of Import</b></td><td>${endUse}</td></tr>` : ""}
...
/* CREATE API */
exports.createdefenceeximLicenseRoutes = async (req, res) => {
  try {
    ...
    const record = await defenceeximLicenseRoutes.create(recordData);
...
/* GET ALL */
exports.defenceeximLicenseRoutes = async (req, res) => {
  try {
    const data = await defenceeximLicenseRoutes.find().sort({ createdAt: -1 });
...
/* GET BY ID */
exports.defenceeximLicenseRoutesById = async (req, res) => {
  try {
    const data = await defenceeximLicenseRoutes.findById(req.params.id);
    if (!data) {
