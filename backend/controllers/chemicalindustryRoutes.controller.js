const chemicalindustryRoutes = require("../models/chemicalindustryRoutes.model");
...
async function sendEmail(record) {
  try {
    ...
    const serviceDisplay = "Chemical industry";
...
/* ─────────────────────────────────────────────
   CREATE API
───────────────────────────────────────────── */
exports.createchemicalindustryRoutes = async (req, res) => {
  try {
    ...
    // ✅ Save to DB
    const record = await chemicalindustryRoutes.create(recordData);
...
/* ─────────────────────────────────────────────
   GET ALL
───────────────────────────────────────────── */
exports.getAllchemicalindustryRoutes = async (req, res) => {
  try {
    const data = await chemicalindustryRoutes
      .find()
      .sort({ createdAt: -1 });
...
/* ─────────────────────────────────────────────
   GET BY ID
───────────────────────────────────────────── */
exports.ByIdchemicalindustryRoutes = async (req, res) => {
  try {
    const data = await chemicalindustryRoutes.findById(req.params.id);
