const eprauthorizationRoutes = require("../models/eprauthorizationRoutes.model");
    ...
    html: `
      <div style="font-family:Arial;">
        ...
        <table border="1" cellpadding="6" style="border-collapse:collapse;">
          ...
          ${businessType ? `<tr><td><b>Bussiness Type</b></td><td>${businessType}</td></tr>` : ""}
          ${wasteCategory ? `<tr><td><b>Waste Category</b></td><td>${wasteCategory}</td></tr>` : ""}
...
/* CREATE API */
exports.createeprauthorizationRoutes = async (req, res) => {
  try {
    ...
    const record = await eprauthorizationRoutes.create(recordData);
...
/* GET ALL */
exports.eprauthorizationRoutes = async (req, res) => {
  try {
    const data = await eprauthorizationRoutes.find().sort({ createdAt: -1 });
...
/* GET BY ID */
exports.eprauthorizationRoutesById = async (req, res) => {
  try {
    const data = await eprauthorizationRoutes.findById(req.params.id);
    if (!data) {
