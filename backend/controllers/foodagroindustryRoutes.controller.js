...
const foodagroindustryRoutes = require("../models/foodagroindustryRoutes.model");
...
async function sendEmail(record) {
  try {
    ...
    const serviceDisplay = "Food Agro industry";
...
/* ─────────────────────────────────────────────
   CREATE API
───────────────────────────────────────────── */
exports.createfoodagroindustryRoutes = async (req, res) => {
  try {
    ...
    // ✅ Save to DB
    const record = await foodagroindustryRoutes.create(recordData);
...
/* ─────────────────────────────────────────────
   GET ALL
───────────────────────────────────────────── */
exports.getAllfoodagroindustryRoutes = async (req, res) => {
  try {
    const data = await foodagroindustryRoutes
      .find()
      .sort({ createdAt: -1 });
...
/* ─────────────────────────────────────────────
   GET BY ID
───────────────────────────────────────────── */
exports.ByIdfoodagroindustryRoutes = async (req, res) => {
  try {
    const data = await foodagroindustryRoutes.findById(req.params.id);
