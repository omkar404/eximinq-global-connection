...
export const ModalEnroll = ({ show, onClose, onSubmit, type }) => {
  ...
  // FIX 2: was declared as 'setloading' (lowercase L) but called as
  //         'setLoading' everywhere → ReferenceError on every submit.
  ...
  ───────────────────────────────────────── */
  const handleSubmit = async (e) => {   // ← 'async' was missing
    e.preventDefault();
