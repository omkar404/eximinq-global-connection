    ...
    <header className="bg-white shadow-sm sticky top-24 z-30">
      <nav className="container mx-auto px-4 py-4 flex justify-center items-center">
        ...
        <div className="hidden md:flex gap-10 font-bold text-sm text-slate-700">
                ...
                <a href="#about" class="hover:text-brand-600 transition">What is SVB?</a>
                <a href="#related" class="hover:text-brand-600 transition">Related Party Check</a>
                <a href="#process" class="hover:text-brand-600 transition">Process</a>
                <a href="#renewal" class="hover:text-brand-600 transition">Renewal</a>
      ...
      {open && (
        <div className="md:hidden bg-white border-t border-slate-100 p-4 text-center font-bold text-slate-700">
          <a href="#home" class="hover:text-brand-600 transition">Home</a>
                ...
                <a href="#related" class="hover:text-brand-600 transition">Related Party Check</a>
                <a href="#process" class="hover:text-brand-600 transition">Process</a>
                <a href="#contact" class="hover:text-brand-600 transition">Renewal</a>
          <a 
            href="#contact"
