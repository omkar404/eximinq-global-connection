      ...
      <nav className="container mx-auto px-4 py-4 flex justify-center items-center">
        ...
        <div className="hidden md:flex gap-10 font-bold text-sm text-slate-700">
          <a href="#home" className="hover:text-brand-600 transition">Home</a>
                <a href="#about" className="hover:text-brand-600 transition">What is IGCR?</a>
                <a href="#forms" className="hover:text-brand-600 transition">Forms (1/2/3)</a>
                <a href="#process" className="hover:text-brand-600 transition">Compliance</a>
  ...
  Extend License
      ...
      {open && (
        <div className="md:hidden bg-white border-t border-slate-100 p-4 text-center font-bold text-slate-700">
          <a href="#home" className="hover:text-brand-600 transition">Home</a>
            <a href="#about" className="block py-2 text-slate-600">What is IGCR?</a>
            <a href="#forms" className="block py-2 text-slate-600">Forms (1/2/3)</a>
            <a href="#process" className="block py-2 text-slate-600">Compliance</a>
            <a href="#contact" className="block py-2 text-brand-600 font-bold">File Return</a>
