...
<div>
                ...
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-6">
                    Simplifying <span className="text-accent-400">CDSCO Registration</span> for Importers
                </h1>
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                    ...
                    <a href="#medical-devices" className="bg-transparent border border-white hover:bg-white hover:text-brand-900 text-center font-semibold py-3 px-8 rounded-lg transition">
                        Medical Devices
                    </a>
                </div>
            </div>
