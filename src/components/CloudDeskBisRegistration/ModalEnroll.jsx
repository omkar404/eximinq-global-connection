...
export const ModalEnroll = ({ show, onClose, onSubmit, type }) => {
  ...
  const SERVICE_MAP = {
    Apply_Now: {
      service: "Bis Registration",
    },
    Request_Quote: {
      service: "Bis Registration",
    },
  Foreign_Manufacturers_Certification_Scheme: {
    service: "Foreign Manufacturers Certification Scheme(FMCS)"
  }
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch(
        ...
        // "http://localhost:5000/api/bis-registration",
        {
          method: "POST",
