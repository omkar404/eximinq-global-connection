    ...
    >
      <div className="container mx-auto px-4 md:px-8 flex justify-between items-center">
        ...
        <div className="hidden md:flex items-center space-x-8 font-medium text-gray-800">
          ...
          <Link className="hover:text-teal-500" to="/services">
            Services
          </Link>
          <Link className="hover:text-teal-500" to="/dgft-customs-consultancy">
            DGFT & Customs
          </Link>
          <Link className="hover:text-teal-500" to="/certificate-of-origin">
            COO
          </Link>
          <Link className="hover:text-teal-500" to="/compliance-trade-india">
            Compliance
          </Link>
          <Link className="hover:text-teal-500" to="/contact-us">
            Contact
          </Link>
          <Link className="hover:text-teal-500" to="/clouddesk-saas">
            SAAS
          </Link>
        </div>
