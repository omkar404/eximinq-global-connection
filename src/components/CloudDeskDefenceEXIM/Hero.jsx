...
<div>
                ...
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-6">
                    <span >Defence EXIM</span > 
                    <span className="text-transparent bg-clip-text bg-gradient-to-r from-accent-400 to-accent-400"> Authorization </span>
                </h1>
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                    ...
                    <a href="#documents" className="bg-transparent border border-white hover:bg-white hover:text-brand-900 text-center font-semibold py-3 px-8 rounded-lg transition">
                        View Munitions List
                    </a>
                </div>
            </div>
