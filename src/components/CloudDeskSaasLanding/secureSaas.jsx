                ...
                <div className="bg-blue-50 border border-blue-100 rounded-3xl p-8 md:p-12 shadow-xl">
                    <div className="text-center mb-10">
                        ...
                        <p className="text-slate-600">
                            Join the waiting list for <strong>May 15, 2026</strong>. Early sign-ups get a <span className="text-blue-600 font-bold">20% Discount</span> on "Historical Data Clean-up" packages.
                        </p>
                    </div>
