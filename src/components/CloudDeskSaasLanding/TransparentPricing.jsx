                    ...
                    <div className="mb-20">
                        ...
                        <div className="text-center mb-10 -mt-6">
                            ...
                            <p className="text-slate-500 text-sm mt-1">
                                Book now with <span className="text-green-400 font-bold">30% advance</span>. Receive PDF Audit Report immediately. Pay balance when Clouddesk goes live.
                            </p>
                        </div>
                        ...
                        <div className="grid md:grid-cols-4 gap-4 max-w-7xl mx-auto">
                            ...
                            <div className="bg-slate-800 rounded-2xl p-6 border border-slate-700 flex flex-col">
                                ...
                                <div className="text-2xl font-bold text-white mb-2">
                                    ₹ 25,000 <span className="text-xs text-green-400">Early Bird</span>
                                </div>
                                ...
                                <button
                                    onClick={() => setShowEnrollModal({ open: true, type: "Last 1 Year Data" })}
                            ...
                            <div className="bg-slate-800 rounded-2xl p-6 border border-blue-500 flex flex-col">
                                ...
                                <div className="text-2xl font-bold text-white mb-2">
                                    ₹ 45,000 <span className="text-xs text-green-400">Early Bird</span>
                                </div>
                                ...
                                <button
                                    onClick={() => setShowEnrollModal({ open: true, type: "Last 2 Years Data" })}
                                    className="w-full py-3 rounded-lg bg-blue-600 text-white font-bold"
                                >
                                    Book for ₹ 13,500
                                </button>
                            ...
                            <div className="bg-slate-800 rounded-2xl p-6 border border-slate-700 flex flex-col">
                                ...
                                <div className="text-2xl font-bold text-white mb-2">
                                    ₹ 60,000 <span className="text-xs text-green-400">Early Bird</span>
                                </div>
                                ...
                                <button
                                    onClick={() => setShowEnrollModal({ open: true, type: "Last 3 Years Data" })}
                            ...
                            <div className="bg-slate-800 rounded-2xl p-6 border border-purple-500 flex flex-col">
                                ...
                                <div className="text-2xl font-bold text-white mb-2">
                                    ₹ 1,00,000 <span className="text-xs text-green-400">Early Bird</span>
                                </div>
                                ...
                                <button
                                    onClick={() => setShowEnrollModal({ open: true, type: "Last 6 Years Archive" })}
