  ...
  return (
    <header className="bg-white shadow-sm sticky top-24 z-30">
      <nav className="container mx-auto px-4 py-4 flex justify-center items-center">
        ...
        <a href="#about" class="hover:text-brand-600 transition">What is FSC?</a>
                <a href="#authorities" class="hover:text-brand-600 transition">Issuing Authority</a>
  ...
  Apply Now
      ...
      {open && (
        <div className="md:hidden bg-white border-t border-slate-100 p-4 text-center font-bold text-slate-700">
          <a href="#home" class="hover:text-brand-600 transition">Home</a>
     <a href="#about" class="block py-2 text-slate-600">What is FSC?</a>
            <a href="#authorities" class="block py-2 text-slate-600">Issuing Authority</a>
            <a href="#documents" class="block py-2 text-slate-600">Documents</a>
            <a href="#contact" class="block py-2 text-brand-600 font-bold">Apply FSC</a>
