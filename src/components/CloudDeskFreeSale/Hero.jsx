      ...
      <div className="container mx-auto px-4 grid md:grid-cols-2 gap-12 items-center">
        <div>
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-6">
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-accent-400 to-accent-400">
              Free Sale Certificate
            </span>{" "}
            Consultant for Exporters
          </h1>
          <p className="text-lg text-slate-200 mb-8 leading-relaxed">
            Get end-to-end help with <strong>FSC issuance</strong>, authority
            routing, domestic licence review, and apostille or legalization
            readiness for overseas product registration.
          </p>
