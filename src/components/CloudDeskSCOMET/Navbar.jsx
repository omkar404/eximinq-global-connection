    ...
    <header className="bg-white shadow-sm sticky top-32 z-30">
      <nav className="container mx-auto px-4 py-4 flex justify-center items-center">
        ...
        <div className="hidden md:flex gap-10 font-bold text-sm text-slate-700">
          ...
          <a href="#categories" class="hover:text-brand-600 transition">
            Categories (0-8)
          </a>
          <a href="#process" class="hover:text-brand-600 transition">
            IMWG Process
          </a>
          <a href="#compliance" class="hover:text-brand-600 transition">
            Compliance
          </a>
        </div>
      ...
      {open && (
        <div className="md:hidden bg-white border-t border-slate-100 p-4 text-center font-bold text-slate-700">
          ...
          <a href="#categories" class="block py-2 text-slate-600">
            Categories (0-8)
          </a>
