...
export const StuckInCustoms = ({ setShowModal }) => {
  return (
    <div className="mt-10 p-8 bg-gradient-to-r from-gray-900 to-indigo-900 rounded-2xl 
    ...
    shadow-2xl relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-md">
        ...
        <p className="text-indigo-200 mb-4">
          Our 24/7 experts can help resolve IGST refunds, query replies, and clearance delays.
        </p>
