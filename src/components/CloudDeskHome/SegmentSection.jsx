...
const SegmentSection = () => {
  ...
  const content = {
    importer: {
      ...
      features: [
        "Duty Calculator with latest cess",
        "IGCR Monthly Returns",
        "Bond/BG Management",
      ],
    ...
    exporter: {
      ...
      features: [
        "RoDTEP & RoSCTL Filing",
        "e-BRC Realization Tracking",
        "Advance Auth Closure",
      ],
        ...
        <div className="bg-gradient-to-r from-slate-900 to-slate-800 rounded-3xl p-8 md:p-12 border border-slate-700 shadow-2xl relative overflow-hidden min-h-[400px]">
          ...
          <div className="relative z-10 flex flex-col md:flex-row items-center gap-12">
            <div className="flex-1 space-y-6">
              <h3 className="text-3xl font-bold text-white transition-all duration-300 animate-fade-in">
