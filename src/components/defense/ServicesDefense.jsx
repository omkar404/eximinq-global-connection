...
import React from "react";
import { Crosshair, Factory, TrendingUp, Plane } from "lucide-react";
...
const services = [
  {
    ...
    features: [
      {
        name: "SCOMET Application",
        href: "/services/scomet-licensing",
        target: "_blank",
        rel: "noopener noreferrer",
      },
      {
        name: "EUC Verification",
        href: "/services/no-due-certificate",
        target: "_blank",
        rel: "noopener noreferrer",
      },
      {
        name: "Post-Shipment Reporting",
  ...
  },
  {
    ...
    features: [
      {
        name: "IOP Certification",
        href: "/services/offset-certification",
        target: "_blank",
        rel: "noopener noreferrer",
      },
      {
        name: "Offset Banking",
        href: "/services/offset-banking",
        target: "_blank",
        rel: "noopener noreferrer",
      },
      {
        name: "Quarterly Reporting",
        href: "/services/offset-reporting",
        target: "_blank",
        rel: "noopener noreferrer",
      },
    ],
    ...
    <section id="services" className="py-20 bg-slate-950 relative">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-slate-400 max-w-2xl mx-auto">
            Specialized consultancy for OEMs, Tier-1 suppliers, and MROs
            navigating the Indian Defense landscape.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {services.map((service) => (
            ...
            >
              {/* Corner Accent */}
              <div
                className="absolute top-0 right-0 w-12 h-12 bg-blue-900/20 rounded-bl-full -mr-6 -mt-6 
                              transition-transform duration-500 
                              group-hover:scale-150 group-hover:bg-blue-800/20"
              />
              ...
              <ul className="space-y-3 pt-4 border-t border-slate-800">
                {service.features.map((feature, i) => (
                  <li key={i}>
                    ...
                    >
                      <span className="w-1 h-1 bg-blue-500 rounded-full group-hover/link:bg-blue-400 transition-colors" />
                      {feature.name}
                    </Link>
                  </li>
                ))}
