// const CTASolar = ({setShowEnrollModal}) => {
//   return (
...
//               setShowEnrollModal({
//                 open: true,
//                 type: "Consult_a_Solar_Expert",
//               })
//             }
//           className="bg-amber-500 hover:bg-amber-600 text-white px-10 py-4 rounded-lg font-bold text-lg shadow-xl transition-all border-b-4 border-amber-700 active:border-b-0 active:translate-y-1">
    ...
    <section className="py-20 bg-sky-800 text-white relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto text-center px-4 relative z-10">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4">
          ...
          <button
            onClick={() => setShowEnrollModal({open:true, type:"Consult_a_Solar_Expert"})} // 🔥 FIXED
            className="bg-amber-500 hover:bg-amber-600 text-white px-10 py-4 rounded-lg font-bold text-lg shadow-xl transition-all border-b-4 border-amber-700 active:border-b-0 active:translate-y-1"
          >
            Consult a Solar Expert
          </button>
          ...
          {/* Download Button */}
          <button
            className="bg-transparent border-2 border-sky-300 hover:bg-sky-700 px-10 py-4 rounded-lg font-bold text-lg transition-all"
          >
            Download MNRE Guide
          </button>
