...
export const ModalEnroll = ({
  ...
  const [form, setForm] = useState({
    ...
    role: "",
    partner: false,
    service: predefinedService || "Solar-industry",
  });

  const isEnroll = !!predefinedService;
  const isSolar = type === "Consult_a_Solar_Expert";
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch(
        `${process.env.REACT_APP_API_URL}/api/solar-and-renewables-industry-import-export`,
        // "http://localhost:5000/api/solar-and-renewables-industry-import-export",
        {
          method: "POST",
