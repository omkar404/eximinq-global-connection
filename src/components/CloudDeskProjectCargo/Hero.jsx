...
<div>
                ...
                <h1 class="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-6">
                    We Move What Others Can't: <span class="text-transparent bg-clip-text bg-gradient-to-r from-accent-400 to-accent-600">Project Cargo</span> Specialists
                </h1>
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                    ...
                    <a href="#benefits" className="bg-transparent border border-white hover:bg-white hover:text-brand-900 text-center font-semibold py-3 px-8 rounded-lg transition">
                        View Fleet
                    </a>
                </div>
            </div>
