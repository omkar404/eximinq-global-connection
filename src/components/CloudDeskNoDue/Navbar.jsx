    ...
    <header className="bg-white shadow-sm sticky top-24 z-30">
      <nav className="container mx-auto px-4 py-4 flex justify-center items-center">
        ...
        <div className="hidden md:flex gap-10 font-bold text-sm text-slate-700">
                ...
                <a href="#about" className="hover:text-brand-600 transition">What is NDC?</a>
                <a href="#scenarios" className="hover:text-brand-600 transition">DEL Removal</a>
      ...
      {open && (
        <div className="md:hidden bg-white border-t border-slate-100 p-4 text-center font-bold text-slate-700">
                         <a href="#about" className="hover:text-brand-600 transition">Why Needed?</a>
                <a href="#scenarios" className="hover:text-brand-600 transition">Scenarios</a>
                <a href="#process" className="hover:text-brand-600 transition">Process</a>
                <a href="#documents" className="hover:text-brand-600 transition">Documents</a>
                <a href="#contact" className="hover:text-brand-600 transition">Start Process</a>
          <a 
            href="#contact"
