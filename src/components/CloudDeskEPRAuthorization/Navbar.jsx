    ...
    <header className="bg-white shadow-sm sticky top-32 z-30">
      ...
      {open && (
        <div className="md:hidden bg-white border-t border-slate-100 p-4 text-center font-bold text-slate-700">
            <a href="#about" class="block py-2 text-slate-600">What is EPR?</a>
            <a href="#categories" class="block py-2 text-slate-600">Categories</a>
            <a href="#process" class="block py-2 text-slate-600">Registration</a>
            <a href="#contact" class="block py-2 text-brand-600 font-bold">Register PIBO</a>
          {/* <a 
            href="#contact"
