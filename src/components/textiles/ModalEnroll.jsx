...
export const ModalEnroll = ({
  ...
  const [form, setForm] = useState({
    ...
    role: "",
    partner: false,
    service: predefinedService || "textiles-industry",
  });

  const isEnroll = !!predefinedService;
  const isBook = type === "Book_Consultation";
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch(
        // `${process.env.REACT_APP_API_URL}/api/textiles-apparels-industry-import-export`,
        "http://localhost:5000/api/textiles-apparels-industry-import-export",
        {
          method: "POST",
