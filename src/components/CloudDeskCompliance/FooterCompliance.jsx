...
const FooterCompliance = ({ setShowModal }) => {
  return (
    <footer className="bg-gray-900 text-gray-300 py-12 border-t border-gray-800 mt-auto">
      <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        {/* Import */}
        <div>
          <h5 className="text-white font-bold mb-4">Import Compliance</h5>
          <ul className="space-y-2 text-sm">
            <li><a href="#" className="hover:text-teal-400">BIS CRS/ISI</a></li>
            <li><a href="#" className="hover:text-teal-400">EPR Waste Mgmt</a></li>
            <li><a href="#" className="hover:text-teal-400">Legal Metrology</a></li>
          </ul>
        </div>

        {/* Export */}
        <div>
          <h5 className="text-white font-bold mb-4">Export Compliance</h5>
          <ul className="space-y-2 text-sm">
            <li><a href="#" className="hover:text-teal-400">EDPMS Closure</a></li>
            <li><a href="#" className="hover:text-teal-400">GST LUT</a></li>
            <li><a href="#" className="hover:text-teal-400">REX Registration</a></li>
          </ul>
        </div>

        {/* CTA */}
        <div>
          <h5 className="text-white font-bold mb-4">Urgent Issue?</h5>
          <button
