    ...
    >
      <div className="container mx-auto px-4 md:px-8 flex justify-between items-center">
        ...
        <div className="hidden md:flex space-x-4 font-smedium text-gray-700">
          ...
          <a href="/dgft-customs-consultancy" className="hover:text-teal-600">
            DGFT & Customs
          </a>
          <a href="/certificate-of-origin" className="hover:text-teal-600">
            COO
          </a>
          <a href="/compliance-trade-india" className="text-teal-600 font-bold">
            Compliance
          </a>
...
export default NavbarCompliance;
