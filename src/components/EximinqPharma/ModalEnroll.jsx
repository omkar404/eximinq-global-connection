...
//     role: "",
//     partner: false,
//     service: "pharmaceuticals-industry",
//   });

//   const isEnroll = !!predefindService;
//   const isgetconsultation = type === "pharmaceuticals_industry_import_export";
...
//       role: "",
//       partner: false,
//       service: predefinedService || "pharmaceuticals industry"
//     });
//     setErrors({});
//     setLoading(false);
//   };
...
//         "http://localhost:5000/api/individual-enroll",
//         {
//           method: "POST",
...
export const ModalEnroll = ({
  ...
  const isgetconsultation = type === "Get_Free_Consultation";
      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-lg relative overflow-hidden">
        ...
        <div className="p-6 md:p-8 overflow-y-auto max-h-[80vh]">
          <form className="space-y-5" onSubmit={handleSubmit}>
            ...
            {/* Category — shown only for consultation type */}
            {isgetconsultation && (
              <div>
                <label className="block text-xs font-bold text-gray-700 mb-1">
                  CATEGORY
