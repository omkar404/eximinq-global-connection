    ...
    <header className="bg-white shadow-sm sticky top-24 z-30">
      <nav className="container mx-auto px-4 py-4 flex justify-center items-center">
        ...
        <div className="hidden md:flex gap-10 font-bold text-sm text-slate-700">
          <a href="#services" className="hover:text-brand-600 transition">
            Services
          </a>
          <a href="#ad-code" className="hover:text-brand-600 transition">
            AD Code
          </a>
        ...
        <button
          onClick={() => setShowEnrollModal({ open: true, type: "Apply_Now" })} 
      ...
      {open && (
        <div className="md:hidden bg-white border-t border-slate-100 p-4 text-center font-bold text-slate-700">
          ...
          <a href="#benefits" className="block py-2">
            Benefits
          </a>
          <a href="#documents" className="block py-2">
            Documents
          </a>
          <a href="#process" className="block py-2">
            Process
          </a>
          <a href="#fees" className="block py-2">
            Feesss
          </a>

          <button
            onClick={() =>
              setShowEnrollModal({ open: true, type: "Apply Now" })
            }
            className="hidden md:inline-block bg-accent-500 hover:bg-accent-600 
             text-white font-bold py-2 px-6 rounded-md shadow-md absolute right-4"
          >
