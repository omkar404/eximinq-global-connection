      ...
      <div className="container mx-auto px-4 grid md:grid-cols-2 gap-12 items-center">
        ...
        <div>
                ...
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-6">
                    Seamless <span className="text-transparent bg-clip-text bg-gradient-to-r from-accent-400 to-accent-600">ICEGATE Registration in India </span> & AD Code Approval
                </h1>
