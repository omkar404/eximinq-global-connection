    ...
    <header className="bg-white shadow-sm sticky top-24 z-30">
      <nav className="container mx-auto px-4 py-4 flex justify-center items-center">
        ...
        <div className="hidden md:flex gap-10 font-bold text-sm text-slate-700">
                <a href="#about" className="hover:text-brand-600 transition">Biosecurity</a>
                <a href="#plant" className="hover:text-brand-600 transition">Plant (PQMS)</a>
                <a href="#animal" className="hover:text-brand-600 transition">Animal (AQCS)</a>
      ...
      {open && (
        <div className="md:hidden bg-white border-t border-slate-100 p-4 text-center font-bold text-slate-700">
            <a href="#about" className="block py-2 text-slate-600">Biosecurity</a>
            <a href="#plant" className="block py-2 text-slate-600">Plant (PQMS)</a>
            <a href="#animal" className="block py-2 text-slate-600">Animal (AQCS)</a>
            <a href="#contact" className="block py-2 text-brand-600 font-bold">Get Permit</a>
          {/* <a 
            href="#contact"
