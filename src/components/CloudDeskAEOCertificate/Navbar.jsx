    ...
    <header className="bg-white shadow-sm sticky top-24 z-30">
      <nav className="container mx-auto px-4 py-4 flex justify-center items-center">
        ...
        <div className="hidden md:flex gap-10 font-bold text-sm text-slate-700">
                <a href="#about" class="hover:text-brand-600 transition">What is MOOWR?</a>
                <a href="#benefits" class="hover:text-brand-600 transition">Benefits</a>
                <a href="#comparison" class="hover:text-brand-600 transition">MOOWR vs EPCG</a>
                <a href="#process" class="hover:text-brand-600 transition">Setup Process</a>
        </div>
      ...
      {open && (
        <div className="md:hidden bg-white border-t border-slate-100 p-4 text-center font-bold text-slate-700">
            <a href="#about" class="block py-2 text-slate-600">What is MOOWR?</a>
            <a href="#benefits" class="block py-2 text-slate-600">Benefits</a>
            <a href="#process" class="block py-2 text-slate-600">Setup Process</a>
            <a href="#contact" class="block py-2 text-brand-600 font-bold">Apply for License</a>
          <a 
            href="#pricing"
