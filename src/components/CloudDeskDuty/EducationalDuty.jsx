...
const EducationalDuty = ({ activeTab, setShowEnrollModal }) => {
  ...
  return (
    <section className="py-20 relative z-10" style={{ background: '#020817' }}>
      <div className="container mx-auto px-6 max-w-4xl">
        {/* Heading */}
        <div className="max-w-4xl mx-auto mt-4 text-slate-400">
        ...
        <div className={`max-w-4xl mx-auto mt-16 text-center ${s.cta.bg} border rounded-2xl p-10 backdrop-blur-sm`}>
          <h2 className="text-2xl font-bold text-white mb-4">{s.cta.heading}</h2>
          <p className="text-slate-400 mb-8">{s.cta.text}</p>
          <button
