...
export const ModalEnroll = ({
  ...
  const [form, setForm] = useState({
    ...
    role: "",
    partner: false,
    service: predefinedService || "Chamicals-industry",
  });

  const isEnroll = !!predefinedService;
  const isConsult = type === "Consult_a_Specialist";
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch(
        // `${process.env.REACT_APP_API_URL}/api/chemicals-industry-import-export`,
        "http://localhost:5000/api/chemicals-industry-import-export",
        {
          method: "POST",
