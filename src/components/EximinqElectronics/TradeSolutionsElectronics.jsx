...
const tradeSolutions = {
  ...
  export: {
    ...
    items: [
      ...
      {
        href: "/", // ✅ Fixed: was "/". (period instead of comma)
        target: "_blank",
        rel: "noopener noreferrer",
        head: "Hardware PLI",
        desc: "Advisory on claiming Production Linked Incentives for IT Hardware and Telecom networking products.",
...
const TradeSolutionsElectronics = ({ activeTab, setActiveTab }) => {
  ...
  const renderCard = (item) => (
    <div className="bg-slate-900/50 p-6 rounded-xl border border-slate-800 hover:border-slate-600 hover:bg-slate-900 transition-all group">
      <div className="flex justify-between items-start mb-2">
        <h4
          className={`text-lg font-bold ${
            activeTab === "import"
