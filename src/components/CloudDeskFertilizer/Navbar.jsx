      ...
      <nav className="container mx-auto px-4 py-4 flex justify-center items-center">
        ...
        <div className="hidden md:flex gap-10 font-bold text-sm text-slate-700">
          <a href="#home" class="hover:text-brand-600 transition">Home</a>
                <a href="#about" class="hover:text-brand-600 transition">About FCO</a>
                <a href="#categories" class="hover:text-brand-600 transition">Categories</a>
                <a href="#process" class="hover:text-brand-600 transition">Registration Process</a>
  ...
  Apply Now
      ...
      {open && (
        <div className="md:hidden bg-white border-t border-slate-100 p-4 text-center font-bold text-slate-700">
          <a href="#home" class="hover:text-brand-600 transition">Home</a>
            <a href="#about" class="block py-2 text-slate-600">About FCO</a>
            <a href="#categories" class="block py-2 text-slate-600">Categories</a>
            <a href="#process" class="block py-2 text-slate-600">Process</a>
            <a href="#contact" class="block py-2 text-brand-600 font-bold">Apply Now</a>
