...
export const ModalEnroll = ({ show, onClose, onSubmit, type }) => {
  ...
  const showEOP = type === "EOP_MANAGEMENT";
  ...
  const validate = () => {
    ...
    if (showEOP && !category) newErrors.category = "Please select a EOP service type.";
    return newErrors;
  };
          ...
          <form className="space-y-5" onSubmit={handleSubmit}>
            ...
            {showEOP && (
              <div>
                ...
                >
                  <option value="">Select EOP Service</option>
                  {EOP_OPTIONS.map((option) => (
