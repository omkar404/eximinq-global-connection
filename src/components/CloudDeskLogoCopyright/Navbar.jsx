    ...
    <header className="bg-white shadow-sm sticky top-24 z-30">
      <nav className="container mx-auto px-4 py-4 flex justify-center items-center">
        ...
        <div className="hidden md:flex gap-10 font-bold text-sm text-slate-700">
                ...
                <a href="#about" class="hover:text-creative-600 transition">Why Copyright Logo?</a>
                <a href="#assets" class="hover:text-creative-600 transition">TM-C Certificate</a>
                <a href="#process" class="hover:text-creative-600 transition">Process</a>
                <a href="#pricing" class="hover:text-creative-600 transition">Fees</a>
        </div>
  ...
  Secure Brand
      ...
      {open && (
        <div className="md:hidden bg-white border-t border-slate-100 p-4 text-center font-bold text-slate-700">
          <a href="#home" class="hover:text-brand-600 transition">Home</a>
            <a href="#about" class="block py-2 text-slate-600">Brand Copyright</a>
            <a href="#assets" class="block py-2 text-slate-600">Assets Covered</a>
            <a href="#process" class="block py-2 text-slate-600">Process</a>
            <a href="#contact" class="block py-2 text-creative-600 font-bold">Secure Brand</a>
          <a 
            href="#contact"
