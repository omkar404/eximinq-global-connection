export const MobileMenuCOO = ({ isMenuOpen, setIsMenuOpen, setShowModal }) => {
  if (!isMenuOpen) return null;

  return (
    <div className="absolute top-[72px] left-0 w-full bg-white shadow-xl border-t z-40 animate-slideDown">
