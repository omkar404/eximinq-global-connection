...
export const ModalEnroll = ({ show, onClose, onSubmit, type }) => {
  ...
  const SERVICE_MAP = {
    End_to_End_AEO_Consultancy: {
      service: "End to End AEO Consultancy",
    },
  };
  ...
  /* CATEGORY ONLY FOR EPCG */
  const showCategory = type === "End_to_End_AEO_Consultancy";
  ...
  const validate = () => {
    ...
    if (showCategory && !category) newErrors.category = "Please select category.";
    return newErrors;
  };
      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-lg relative overflow-hidden">
        ...
        <div className="p-6 md:p-8 overflow-y-auto max-h-[80vh]">
          <form className="space-y-5" onSubmit={handleSubmit}>
            ...
            {/* CATEGORY DROPDOWN (only for EPCG) */}
            {showCategory && (
              <div>
                <label className="block text-xs font-bold text-gray-700 mb-1 uppercase">
                  Category
