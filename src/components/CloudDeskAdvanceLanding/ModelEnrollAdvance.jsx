...
export const ModalEnrollAdvance = ({ show, onClose, onSubmit, type }) => {
  ...
  const SERVICE_MAP = {
    advance_authorization_redemption: {
      service: "advance authorization redemption",
    },
    // Request_Callback: {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch(
        ...
        // "http://localhost:5000/api/advance-authorization-redemption",
        {
          method: "POST",
