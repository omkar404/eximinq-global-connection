...
export default function QuickAdvance() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch(
        `${process.env.REACT_APP_API_URL}/api/advance-authorization-redemption`, 
        // "http://localhost:5000/api/advance-authorization-redemption", // ✅ http:// is required        
      {
        method: "POST",
        ...
        <div className="flex flex-col lg:flex-row gap-16 items-center">
          ...
          <div className="w-full lg:w-1/2">
            <div className="bg-white rounded-2xl p-8 shadow-2xl">
              <h3 className="text-2xl font-bold text-slate-900 mb-6">Request License Audit</h3>
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div>
                  <input type="text" name="licenseNumber" value={formData.licenseNumber} onChange={handleChange}
                    placeholder="Advance Auth License Number"
                ...
                <select name="requirement" value={formData.requirement} onChange={handleChange}
                  ...
                  <option>AA Redemption / EODC</option>
                  <option>Clubbing / Revalidation</option>
