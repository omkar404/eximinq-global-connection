    ...
    <header className="bg-white shadow-sm sticky top-24 z-30">
      <nav className="container mx-auto px-4 py-4 flex justify-center items-center">
        ...
        <div className="hidden md:flex gap-10 font-bold text-sm text-slate-700">
          <a href="#about" className="hover:text-brand-600 transition">What is MOOWR?</a>
          <a href="#benefits" className="hover:text-brand-600 transition">Benefits</a>
          <a href="#comparison" className="hover:text-brand-600 transition">MOOWR vs EPCG</a>
          <a href="#process" className="hover:text-brand-600 transition">Setup Process</a>
