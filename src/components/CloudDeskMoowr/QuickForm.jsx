...
const QuickForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      alert(
        "✅ We have received your MOOWR request — we'll contact you shortly.",
      );
  ...
  return (
    <div className="bg-white text-slate-800 rounded-xl shadow-2xl p-4 md:p-5">
      ...
      <div className="flex items-center gap-2 mb-1">
        <ChartColumn className="text-brand-600" size={22} />
        <h3 className="text-lg font-bold text-brand-900">Check Feasibility</h3>
      </div>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="mb-2.5">
          ...
          <select
            ...
            value={form.sector}
            onChange={handleChange}
            className="w-full border border-slate-300 rounded px-2.5 py-1.5 text-sm bg-white focus:outline-none focus:border-brand-500"
          >
