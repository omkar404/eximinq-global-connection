          ...
          <div className="container mx-auto px-4 max-w-5xl">
            ...
            <div className="prose lg:prose-lg mx-auto text-slate-600 text-justify">
              ...
              <p className="mb-4">
                ...
                import. The duty is deferred until the finished goods are
                cleared for the domestic market. If the finished goods are
                exported, the deferred duty on inputs is{" "}
                <strong>fully remitted</strong>.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <div className="bg-white p-8 rounded-xl shadow-md border-t-4 border-accent-500 hover:shadow-xl transition">
                ...
                <p className="text-slate-600 text-sm">
                  Unlike EPCG/Advance Authorization, MOOWR has no export
                  targets. You can sell 100% domestically without restrictions.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="container mx-auto px-4 max-w-5xl">
            <div className="text-center mb-12">
              ...
              <p className="text-slate-500">
                MOOWR turns your factory into a 'Legal Customs Vault.' CloudDesk
                ensures the keys always turn smoothly.
              </p>
            </div>
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="flex gap-4 p-6 bg-slate-50 rounded-xl border border-slate-100">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-600 leading-relaxed">
                    Unlike Advance Authorisation, <strong>MOOWR </strong>has no
                    fixed export obligation and no time limit for duty deferral.
                    <strong>CloudDesk</strong> architects your licensing so that
                    you only pay duty if and when you sell to the{" "}
                    <strong>domestic market (DTA).</strong> If you export, the
                    duty is waived forever.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-4 p-6 bg-slate-50 rounded-xl border border-slate-100">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-600 leading-relaxed">
                    Getting a <strong>MOOWR license </strong>involves both a
                    Bonded <strong>Warehouse License </strong>(Sec 58) and
                    Permission for Manufacturing (Sec 65).{" "}
                    <strong>CloudDesk</strong> handles the dual-application
                    process, ensuring your factory layout, security protocols,
                    and bond execution are approved by the Commissioner in one
                    go.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-4 p-6 bg-slate-50 rounded-xl border border-slate-100">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-600 leading-relaxed">
                    The biggest compliance hurdle is the{" "}
                    <strong>
                      Triple-Column Ledger (Input, Process, Output).
                    </strong>
                    <strong>CloudDesk’s </strong>Bonded-Inventory Module
                    automates this ledger, ensuring your raw material
                    consumption matches your{" "}
                    <strong>export/domestic sales perfectly,</strong> making
                    your monthly returns "Audit-Proof."
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-4 p-6 bg-slate-50 rounded-xl border border-slate-100">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-600 leading-relaxed">
                    While Customs duty is deferred,{" "}
                    <strong>IGST rules are complex under MOOWR.</strong>
                    <strong>CloudDesk </strong>performs a Tax-Optimization Audit
                    to ensure you aren't accidentally blocking your GST credits
                    while trying to save on Customs duty.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <details className="bg-white p-6 rounded-lg shadow-sm border border-slate-200 group">
                ...
                <p className="text-sm text-slate-600 mt-4 leading-relaxed">
                  It allows you to import capital goods and raw materials into a
                  bonded warehouse (your factory) without paying BCD (Basic
                  Customs Duty) or IGST. You only pay these taxes when you clear
                  the finished goods into the Indian domestic market. If you
                  export the finished goods, you pay zero duty.
                </p>
              </details>
              ...
              <details className="bg-white p-6 rounded-lg shadow-sm border border-slate-200 group">
                ...
                <p className="text-sm text-slate-600 mt-4 leading-relaxed">
                  "• No Export Obligation: Unlike EOUs, there is no ""Net
                  Foreign Exchange"" (NFE) requirement. • No Location
                  Restriction: Unlike SEZs, you can set up a MOOWR unit anywhere
                  in India. • Ease of Exit: Exiting MOOWR is significantly
                  simpler than exiting an SEZ or EOU."
                </p>
              </details>
              ...
              <details className="bg-white p-6 rounded-lg shadow-sm border border-slate-200 group">
                <summary className="font-bold text-slate-800 cursor-pointer flex justify-between items-center">
                  Is there a time limit for keeping goods in the MOOWR
                  warehouse?
                  <ChevronDown
                    size={20}
                    className="text-brand-500 transition-transform group-open:rotate-180"
                ...
                <p className="text-sm text-slate-600 mt-4 leading-relaxed">
                  No. You can keep raw materials or capital goods in the bonded
                  premises indefinitely without paying duty until they are
              ...
              <details className="bg-white p-6 rounded-lg shadow-sm border border-slate-200 group">
                ...
                <p className="text-sm text-slate-600 mt-4 leading-relaxed">
                  Any person (Proprietorship, Partnership, or Company) who has
                  been granted a license under Section 58 of the Customs Act for
                  a bonded warehouse and intends to carry out manufacturing or
                  other operations under Section 65.
                </p>
              </details>
              ...
              <details className="bg-white p-6 rounded-lg shadow-sm border border-slate-200 group">
                ...
                <p className="text-sm text-slate-600 mt-4 leading-relaxed">
                  Your premises must be secure. Requirements include: (1) Strong
                  physical boundaries, (2) 24/7 CCTV surveillance with a 30-day
                  backup, and (3) Digital record-keeping of all entry and exit.
                  CloudDesk provides a Security Checklist to ensure you meet
                  these before the inspector arrives.
                </p>
              </details>
              ...
              <details className="bg-white p-6 rounded-lg shadow-sm border border-slate-200 group">
                ...
                <p className="text-sm text-slate-600 mt-4 leading-relaxed">
                  No. You use your existing IEC. However, your ICEGATE ID must
                  be mapped to the specific Bonded Warehouse Code generated
              ...
              <details className="bg-white p-6 rounded-lg shadow-sm border border-slate-200 group">
                ...
                <p className="text-sm text-slate-600 mt-4 leading-relaxed">
                  You must file an Ex-Bond Bill of Entry and pay the deferred
                  BCD and IGST on the raw materials used in that product. There
                  is no interest charged on the deferred duty if paid at the
                  time of clearance.
                </p>
              </details>
              ...
              <details className="bg-white p-6 rounded-lg shadow-sm border border-slate-200 group">
                ...
                <p className="text-sm text-slate-600 mt-4 leading-relaxed">
                  Yes. Inter-unit transfers are permitted without payment of
                  duty, making it an excellent scheme for companies with
                  multiple manufacturing stages across different locations.
                </p>
              </details>
            </div>
          </div>
