    ...
    <section id="about" className="py-20 bg-white">
        <div className="container mx-auto px-4 max-w-5xl">
            <div className="text-center mb-12">
                <h2 className="text-3xl font-bold text-slate-900 mb-4">What is Duty Free Import Authorisation?</h2>
                <div className="w-24 h-1 bg-accent-500 mx-auto rounded"></div>
            </div>
            <div className="prose lg:prose-lg mx-auto text-slate-600 text-justify">
                <p className="mb-4">
                    <strong>Duty Free Import Authorisation (DFIA)</strong> is an export incentive scheme issued to allow duty-free import of inputs. Unlike Advance Authorisation, DFIA is issued on a <strong>post-export basis</strong> for products for which Standard Input Output Norms (SION) are notified.
                </p>
                
                <p className="mb-4">
                    The key feature of DFIA is <strong>Transferability</strong>. Once the export obligation is fulfilled and the license is endorsed as "Transferable" by DGFT, it can be sold to any other importer. The buyer can use it to import the specified raw materials without paying Basic Customs Duty (BCD).
                </p>
            </div>
        </div>
    </section>
    ...
    <section id="benefits" className="py-20 bg-slate-50">
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="bg-white rounded-xl shadow-md p-8 border-t-4 border-green-500 
            ...
            <p className="text-sm text-slate-600">
              Once transferable, you can sell the license at a premium to other
              importers, converting duty savings into direct cash profit.
            </p>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-md p-8 border-t-4 border-blue-500 
            ...
            <div className="w-16 h-16 bg-blue-100 rounded-full flex items-center 
                            justify-center mx-auto mb-6 text-blue-600">
              <ShieldCheck size={30} />
            </div>
            <h3 className="text-xl font-bold text-slate-900 mb-3">
              Exemptions
            ...
            <p className="text-sm text-slate-600">
              Exempts Basic Customs Duty (BCD). Note: IGST is usually payable under
              DFIA unless specific notifications apply.
            </p>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-md p-8 border-t-4 border-purple-500 
            ...
            <div className="w-16 h-16 bg-purple-100 rounded-full flex items-center 
                            justify-center mx-auto mb-6 text-purple-600">
              <Boxes size={30} />
            </div>
            <h3 className="text-xl font-bold text-slate-900 mb-3">
              SION Based
            ...
            <p className="text-sm text-slate-600">
              Issued only for products with fixed SION norms. Requires a minimum
              value addition of <strong>20%</strong> (higher than Advance
              Authorisation).
            </p>
          </div>
        ...
        <div className="mt-12 bg-yellow-50 border border-yellow-200 p-6 
                        rounded-lg text-center max-w-3xl mx-auto">
          <h4 className="font-bold text-yellow-800 text-lg mb-2 flex 
                         items-center justify-center gap-2">
            <AlertCircle size={20} />
            Important Restriction
          </h4>
          <p className="text-sm text-yellow-700">
            Inputs imported under DFIA cannot be used for manufacturing export
            products where other benefits like Drawback are claimed. It works
            best for exporters who have already paid duty on inputs and want a
            transferable credit.
          </p>
        </div>
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-slate-300 mt-2">
            Step-by-step guide to monetizing your DFIA.
          </p>
        </div>
        ...
        <div className="relative grid md:grid-cols-4 gap-8 step-connector">
          ...
          <div className="text-center relative z-10">
            <div
              className="w-16 h-16 bg-white rounded-full flex items-center 
                         justify-center text-2xl font-bold text-brand-900 
            ...
            <p className="text-sm text-slate-300">
              File Shipping Bill under <strong>DFIA Scheme</strong>. Ensure
              <strong> No Drawback</strong> is claimed.
            </p>
          </div>
          ...
          <div className="text-center relative z-10">
            ...
            <p className="text-sm text-slate-300">
              File online application to DGFT with <strong>E-BRC</strong> and
          ...
          <div className="text-center relative z-10">
            ...
            <h3 className="text-lg font-bold mb-2">Transferability</h3>
            <p className="text-sm text-slate-300">
              DGFT issues the license. Submit documents to make it
          ...
          <div className="text-center relative z-10">
            <div
              className="w-16 h-16 bg-green-500 rounded-full flex items-center 
                         justify-center text-2xl font-bold text-white 
                         mx-auto mb-4 border-4 border-white shadow-sm"
            >
              <Handshake size={28} />
            </div>
            <h3 className="text-lg font-bold mb-2">Sale / Import</h3>
            <p className="text-sm text-slate-300">
              Sell the license in the market or use it to import inputs
              duty-free.
            </p>
          </div>
        ...
        <div className="container mx-auto px-4 grid md:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
                    ...
                    <li><a href="#" class="hover:text-white transition">DFIA License</a></li>
                    <li><a href="#" class="hover:text-white transition">RoDTEP Scrips</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
                    <li><a href="#" class="hover:text-white transition">SION List</a></li>
                    <li><a href="#" class="hover:text-white transition">Value Addition Norms</a></li>
                    <li><a href="#" class="hover:text-white transition">Transferability Rules</a></li>
