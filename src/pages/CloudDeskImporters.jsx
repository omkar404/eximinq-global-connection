            ...
            <div className="grid lg:grid-cols-[1fr_1.1fr] gap-8 bg-white rounded-[2rem] overflow-hidden shadow-2xl">
              <div className="bg-brand-700 text-white p-10 lg:p-14">
                ...
                <h2 className="text-4xl font-bold mt-3 mb-5">
                  Need Import Monitoring Registration Before Your Shipment
                  Moves?
                </h2>
                <p className="text-blue-100 text-lg leading-8 mb-8">
                  We help importers identify the right DGFT monitoring regime,
                  prepare the product data, and file in time for smoother
                  customs readiness.
                </p>
              ...
              <div className="p-10 lg:p-14 flex flex-col justify-center">
                <h3 className="text-3xl font-bold text-slate-900 mb-4">
                  Start Your Import Registration Request
                </h3>
                <p className="text-slate-600 leading-7 mb-8">
                  Use the product-specific application options above or speak to
                  our team first if you need help identifying the correct
                  monitoring category.
                </p>
                ...
                <div className="grid sm:grid-cols-2 gap-4 mb-6">
                  ...
                  >
                    Review Covered Systems
                  </a>
                </div>

                <div className="rounded-2xl bg-slate-50 border border-slate-200 p-5 text-sm text-slate-600">
                  Best for: importers handling notified steel, paper,
                  non-ferrous, coal, chip, or other monitored products that need
                  correct registration before customs filing.
                </div>
              </div>
            </div>
          </div>
