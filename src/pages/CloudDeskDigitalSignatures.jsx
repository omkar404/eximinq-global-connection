...
const CloudDeskDigitalSignatures = () => {
  ...
  <meta
    name="description"
    content="Apply for Class 3 Digital Signature (DSC) for DGFT, ICEGATE, GST and e-Tender portals. Combo signing + encryption with fast approval."
  />
      ...
      "@graph": [
        ...
        },
        {
          ...
          "mainEntity": [
            {
              "@type": "Question",
              "name": "Is Class 2 DSC still valid in 2026?",
              "acceptedAnswer": {
                "@type": "Answer",
                "text": "No. All Class 2 certificates have expired or been discontinued. You must upgrade to Class 3 for all government portals, including GST, Income Tax, MCA, and DGFT."
              }
            },
            {
              "@type": "Question",
              "name": "What is the difference between \"Signing\" and \"Encryption\" DSC?",
              "acceptedAnswer": {
                "@type": "Answer",
                "text": "Signing: Proves who signed the document (Authenticity). Used for GST, ITR, and MCA.Encryption : Scrambles the data so only the intended recipient can read it (Confidentiality). Mandatory for e-Tenders and certain Customs filings."
              }
            },
            {
              "@type": "Question",
              "name": "Can I use the same DSC for my personal ITR and my company’s GST?",
              "acceptedAnswer": {
                "@type": "Answer",
                "text": "Yes, if you are the Authorized Signatory for both. A Class 3 DSC is issued to an individual (linked to their PAN), and that individual can use it across multiple roles (Director, Proprietor, Individual)."
              }
            }
          ]
        },
