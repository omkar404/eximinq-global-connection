          ...
          {JSON.stringify({
            ...
            "@graph": [
              ...
              },
              {
                "@type": "Service",
                serviceType:
                  "Interest Equalisation Scheme and export credit interest subvention support",
          ...
          <div className="container mx-auto px-4 max-w-5xl">
            ...
            <div className="prose lg:prose-lg mx-auto text-slate-600 text-justify">
              <p className="mb-4">
                ...
                export credit at a lower interest rate. The government
                reimburses the banks the difference (equalisation amount), and
                the banks pass this benefit to the exporter by charging a
                reduced rate.
              </p>

              <p className="mb-4">
                Example: If the bank's standard rate is 9% and you are eligible
                for a 3% subsidy, the bank will charge you only 6%. This scheme
                is crucial for making Indian exports competitive by lowering the
                cost of capital.
              </p>
            </div>
          </div>
            ...
            <div className="grid md:grid-cols-2 gap-12 max-w-5xl mx-auto">
              ...
              >
                <div className="p-8">
                  ...
                  <p className="text-slate-600 text-sm mb-6 leading-relaxed">
                    Available only for{" "}
                    <strong>410 Specific Tariff Lines</strong> identified by
                    DGFT. Merchant exporters are generally excluded unless
                    specified.
                  </p>
            ...
            <div className="grid md:grid-cols-2 gap-16 items-center">
              ...
              <div>
                ...
                <p className="text-slate-300 mb-8 leading-relaxed">
                  ...
                  to your bank denying the interest subvention. We audit your
                  file to ensure zero rejections.
                </p>
              ...
              <div className="relative bg-white text-slate-800 rounded-xl p-8 shadow-2xl">
                ...
                <p className="text-sm text-slate-600 mb-6">
                  Did you miss claiming IES in the past? It may still be
                  possible to claim retrospectively if the shipment falls within
                  the eligible period and documents are in order.
                </p>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="relative grid md:grid-cols-4 gap-8 step-connector">
              ...
              <div className="text-center relative z-10">
                ...
                <p className="text-sm text-slate-500">
                  Ensure the correct <strong>Scheme Code</strong> is mentioned
          ...
          <div className="container mx-auto px-4 max-w-5xl">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-slate-900 mb-2">
                Why CloudDesk for Interest-Equalisation-scheme?
              </h2>
              <p className="text-slate-500">
                Banks won't give you the discount unless you give them the UIN.
                CloudDesk ensures your finance is 'Subvention-Ready' before you
                sign the loan.
              </p>
            </div>
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="flex gap-4 p-6 bg-slate-50 rounded-xl border border-slate-100">
                ...
                <div>
                  <h4 className="font-bold text-slate-900 mb-2">
                    1. The "UIN-First" Compliance
                  </h4>
                  <p className="text-sm text-slate-600 leading-relaxed">
                    In 2026, you cannot walk into a bank and ask for a
                    subvention. You must first file an
                    <strong> "Intent to Avail" </strong>on the DGFT portal to
                    generate a
                    <strong> Unique Identification Number (UIN).</strong>
                    <strong>CloudDesk </strong>handles this digital filing,
                    ensuring your HSN codes match the
                    <strong>
                      {" "}
                      "Positive List" (which covers ~75% of tariff lines).
                    </strong>
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-4 p-6 bg-slate-50 rounded-xl border border-slate-100">
                ...
                <div>
                  <h4 className="font-bold text-slate-900 mb-2">
                    2. The ₹50 Lakh Cap Sentinel
                  </h4>
                  <p className="text-sm text-slate-600 leading-relaxed">
                    The subvention is now capped at
                    <strong> ₹50 Lakh per IEC per financial year.</strong>
                    <strong>CloudDesk’s Finance </strong>Tracker monitors your
                    aggregate claims across multiple banks. We alert you when
                    you are nearing the cap so you don't over-claim, which now
                    triggers a mandatory<strong> "Voluntary Surrender" </strong>
              ...
              <div className="flex gap-4 p-6 bg-slate-50 rounded-xl border border-slate-100">
                ...
                <div>
                  <h4 className="font-bold text-slate-900 mb-2">
                    3. HSN Positive List Validation
                  </h4>
                  <p className="text-sm text-slate-600 leading-relaxed">
                    Not all products qualify anymore. The 2026 scheme excludes
                    <strong>
                      {" "}
                      Waste/Scrap, PLI-covered products, and Restricted items.
                    </strong>
                    We perform a <strong>Product-Subvention Audit </strong>to
                    confirm your HSN is on the current
                    <strong> "Positive List" </strong>before you commit to an
                    export order.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-4 p-6 bg-slate-50 rounded-xl border border-slate-100">
                ...
                <div>
                  <h4 className="font-bold text-slate-900 mb-2">
                    4. Bank Liaison & Auditor Certification
                  </h4>
                  <p className="text-sm text-slate-600 leading-relaxed">
                    Banks require a specific External Auditor Certification to
                    claim the reimbursement from<strong> RBI. </strong>
                    <strong>CloudDesk </strong>coordinates with your auditors
                    and the bank’s trade finance desk to ensure the
                    <strong> "Interest-Relief" </strong>is passed on upfront—so
                    you pay less interest from Day 1, rather than waiting for a
                    refund.
                  </p>
                </div>
              </div>
            ...
            <div className="space-y-4">
              ...
              <details className="bg-white p-6 rounded-lg shadow-sm border border-slate-200 group">
                ...
                <p className="text-sm text-slate-600 mt-4 leading-relaxed">
                  The base rate is 2.75% per annum for all eligible MSME (Micro,
                  Small, and Medium) manufacturer exporters.
                </p>
              </details>
              ...
              <details className="bg-white p-6 rounded-lg shadow-sm border border-slate-200 group">
                ...
                <p className="text-sm text-slate-600 mt-4 leading-relaxed">
                  No. As of the 2026 revamp, the scheme is exclusively for MSME
                  Manufacturers. Non-MSME and Merchant exporters have been moved
                  out of the fresh claim cycle to focus resources on small-scale
                  manufacturing.
                </p>
              </details>
              ...
              <details className="bg-white p-6 rounded-lg shadow-sm border border-slate-200 group">
                ...
                <p className="text-sm text-slate-600 mt-4 leading-relaxed">
                  Yes. The fiscal benefit is capped at ₹50 Lakh per exporting
                  firm per financial year.
                </p>
              </details>
              ...
              <details className="bg-white p-6 rounded-lg shadow-sm border border-slate-200 group">
                ...
                <p className="text-sm text-slate-600 mt-4 leading-relaxed">
                  You need a UIN to be shared with your bank. The UIN is
                  generally valid for one year. If you deal with multiple banks,
                  you must ensure the total subvention across all banks stays
                  under the ₹50 Lakh cap.
                </p>
              </details>
              ...
              <details className="bg-white p-6 rounded-lg shadow-sm border border-slate-200 group">
                ...
                <p className="text-sm text-slate-600 mt-4 leading-relaxed">
                  The government now maintains a list of HSN 6-digit codes that
                  are eligible for the 2.75% subvention. If your product is not
                  on this list (e.g., certain steel or chemical lines), you
              ...
              <details className="bg-white p-6 rounded-lg shadow-sm border border-slate-200 group">
                ...
                <p className="text-sm text-slate-600 mt-4 leading-relaxed">
                  You need an Active IEC, Udyam Registration, and a valid
                  Digital Signature (DSC). CloudDesk handles the portal
                  navigation and document attachment (Export Orders, etc.).
                </p>
              </details>
              ...
              <details className="bg-white p-6 rounded-lg shadow-sm border border-slate-200 group">
                ...
                <p className="text-sm text-slate-600 mt-4 leading-relaxed">
                  No. Products covered under any Production Linked Incentive
                  (PLI) scheme are specifically excluded from interest
                  subvention in 2026 to prevent "Incentive Overlap."
                </p>
              </details>
              ...
              <details className="bg-white p-6 rounded-lg shadow-sm border border-slate-200 group">
                ...
                <p className="text-sm text-slate-600 mt-4 leading-relaxed">
                  If you exceed the ₹50 Lakh cap, you must voluntarily surrender
                  the excess within the same financial year. Failure to do so
                  renders you liable for the amount plus interest/penalties from
                  the DGFT.
                </p>
              </details>
            </div>
