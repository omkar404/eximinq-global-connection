...
const CloudDeskNoDue = () => {
  ...
  return (
    <>
      <Helmet>
        <title>
          No Incentive Certificate for Returned Goods | No Incentive
            ...
            <div className="space-y-4">
              ...
              <details className="bg-white p-6 rounded-lg shadow-sm border border-slate-200 group">
                ...
                <p className="text-sm text-slate-600 mt-4 leading-relaxed">
                  The NDC proves that you have not only fulfilled the "Export
                  Obligation" but have also paid any administrative fees, late
                  fees, or penalties that might have been levied during the
                  6-year license tenure.
                </p>
              </details>
              ...
              <details className="bg-white p-6 rounded-lg shadow-sm border border-slate-200 group">
                ...
                <p className="text-sm text-slate-600 mt-4 leading-relaxed">
                  No. Customs will only "Cancel" the bond and release the BG
                  once the License Cell issues a "Closure Order," which is
                  contingent upon an NDC from the Fine & Penalty (F&P) section.
                </p>
              </details>
              ...
              <details className="bg-white p-6 rounded-lg shadow-sm border border-slate-200 group">
                <summary className="font-bold text-slate-800 cursor-pointer flex justify-between items-center">
                  How long does it take to get a No Due Certificate from
                  Customs?
                  <ChevronDown
                    className="text-brand-500 transition-transform group-open:rotate-180"
                    size={20}
                ...
                <p className="text-sm text-slate-600 mt-4 leading-relaxed">
                  If your records are clear, it takes 7–15 working days. If
                  there are pending "Queries" or unpaid "Demands," it can take
                  months. CloudDesk’s Pre-Check identifies these demands before
                  you apply.
                </p>
              </details>
              ...
              <details className="bg-white p-6 rounded-lg shadow-sm border border-slate-200 group">
                ...
                <p className="text-sm text-slate-600 mt-4 leading-relaxed">
                  It is a digital or physical document issued by the carrier
                  (e.g., Maersk, MSC) confirming that ocean freight, local
                  charges, and "Detention" (if any) are paid. Without this, you
                  cannot get the Delivery Order (DO).
                </p>
              </details>
              ...
              <details className="bg-white p-6 rounded-lg shadow-sm border border-slate-200 group">
                ...
                <p className="text-sm text-slate-600 mt-4 leading-relaxed">
                  Yes. The CFS NDC (or "Pass-out") confirms that handling,
                  scanning, and "Demurrage" (storage) charges are settled.
                  CloudDesk integrates these payments into your dashboard for
                  one-click clearance.
                </p>
              </details>
              ...
              <details className="bg-white p-6 rounded-lg shadow-sm border border-slate-200 group">
                ...
                <p className="text-sm text-slate-600 mt-4 leading-relaxed">
                  Yes. You must prove to the DGFT that there are no "Incomplete
                  Export Obligations" linked to your IEC. If you have open
                  licenses, you must either fulfill them or "Regularize" them
                  (pay duty + interest) to get the NDC.
                </p>
              </details>
              ...
              <details className="bg-white p-6 rounded-lg shadow-sm border border-slate-200 group">
                ...
                <p className="text-sm text-slate-600 mt-4 leading-relaxed">
                  Absolutely. Even an unproven notice will block your NDC.
                  CloudDesk helps you file an "Ad-hoc Bond" or resolve the
                  notice through the Adjudication process to clear the path for
                  the NDC.
                </p>
              </details>
              ...
              <details className="bg-white p-6 rounded-lg shadow-sm border border-slate-200 group">
                ...
                <p className="text-sm text-slate-600 mt-4 leading-relaxed">
                  For large corporates, the EXIM department must provide an NDC
                  to the Finance department before an "Export Incentive" is
                  booked as profit. CloudDesk provides the Compliance Report
                  that serves as this internal NDC.
                </p>
              </details>
            </div>
          </div>
