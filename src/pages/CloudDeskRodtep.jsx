    ...
    <>
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "@graph": [
              ...
              {
                "@type": "Service",
                "name": "RoDTEP Scheme Consultancy",
                "serviceType": "Duty Remission Scheme",
                "description":
                  "Professional support for RoDTEP claims, HS code rate verification, ICEGATE ledger setup and duty credit scrip transfer.",
                "provider": {
                  "@type": "Organization",
              ...
              },
              {
                ...
                "mainEntity": [
                  {
                    "@type": "Question",
                    "name": "Is RoDTEP applicable for Advance Authorisation / EOU?",
                    "acceptedAnswer": {
                      "@type": "Answer",
                      "text": "RoDTEP is a duty remission scheme that refunds embedded taxes on exported products through transferable electronic scrips."
                    }
                  },
                  {
                    "@type": "Question",
                    "name": "Does the RoDTEP scrip expire?",
                    "acceptedAnswer": {
                      "@type": "Answer",
                      "text": "Yes, RoDTEP scrips are freely transferable and can be used to pay Basic Customs Duty."
                    }
                  },
                  {
                    "@type": "Question",
                    "name": "What duties can be paid using RoDTEP scrips?",
                    "acceptedAnswer": {
                      "@type": "Answer",
                      "text": "Yes, the validity period of the scrip is generally one year from the date of its generation. It must be utilized for duty payment or transferred within this period."
                    }
                  },
                  {
                    "@type": "Question",
                    ...
                    "acceptedAnswer": {
                      "@type": "Answer",
                      "text": "RoDTEP scrips can be used to pay Basic Customs Duty (BCD) only. They cannot be used to pay IGST, Compensation Cess, or other surcharges."
                    }
                  },
                  {
                    "@type": "Question",
                  ...
                  {
                    "@type": "Question",
                    "name": "What is the main difference between RoDTEP and RoSCTL?",
                    "acceptedAnswer": {
                      "@type": "Answer",
                      "text": " RoDTEP: Covers almost all sectors (Engineering, Chemicals, Agriculture, etc.). • RoSCTL: Specifically for Apparel, Garments, and Made-ups (Chapters 61, 62, and 63). It provides a higher rebate because the textile sector has more embedded taxes."
                    }
                  },
                  {
                    "@type": "Question",
                    "name": "What is a \"Duty Credit Scrip\"?",
                    "acceptedAnswer": {
                      "@type": "Answer",
                      "text": "It is a digital currency issued by Customs. You can use it to pay Basic Customs Duty (BCD) on your future imports, or you can sell it to someone else who needs to pay duty."
                    }
                  },
                  {
                    "@type": "Question",
                    "name": "Can I claim RoDTEP if I am also using Advance Authorisation?",
                    "acceptedAnswer": {
                      "@type": "Answer",
                      "text": "Yes, but at a lower rate. In 2026, the government has enabled RoDTEP for AA/EPCG/EOU units, but the \"RoDTEP for AA\" rates are typically lower than the \"Normal RoDTEP\" rates. CloudDesk calculates which combination gives you the highest net saving."
                    }
                  },
                  {
                    "@type": "Question",
                    "name": "How do I claim the benefit?",
                    "acceptedAnswer": {
                      "@type": "Answer",
                      "text": "There is no separate application. You must declare your intent in the Shipping Bill (using specific codes for RoDTEP or RoSCTL). Once the EGM (Export General Manifest) is filed, the credit is automatically processed into your ICEGATE Ledger."
                    }
                  },
                  {
                    "@type": "Question",
                    "name": "What is the validity of the Scrip?",
                    "acceptedAnswer": {
                      "@type": "Answer",
                      "text": "Typically, the scrips are valid for 1 or 2 years from the date of generation. If you don't use or sell them within this window, the value becomes zero. CloudDesk’s Expiry Alert ensures you never lose a scrip."
                    }
                  },
                  {
                    "@type": "Question",
                    "name": "Can I use RoDTEP to pay IGST?",
                    "acceptedAnswer": {
                      "@type": "Answer",
                      "text": "No. RoDTEP and RoSCTL scrips can only be used to pay Basic Customs Duty (BCD). They cannot be used for IGST, Compensation Cess, or Antidumping Duty."
                    }
                  },
                  {
                    "@type": "Question",
                    "name": "Is it legal to sell RoDTEP scrips?",
                    "acceptedAnswer": {
                      "@type": "Answer",
                      "text": "Yes. These scrips are \"Freely Transferable.\" You can transfer them to any other IEC holder via the ICEGATE portal."
                    }
                  },
                  {
                    "@type": "Question",
                    "name": "How much \"Cash\" will I get if I sell my scrip?",
                    "acceptedAnswer": {
                      "@type": "Answer",
                      "text": "Scrips usually sell at a discount. For example, a ₹100 scrip might sell for ₹97 or ₹98 in the market. CloudDesk finds the buyer with the lowest discount (highest premium) for you."
                    }
                  },
      ...
      />
        ...
        <section className="py-20 bg-white">
          <div className="container mx-auto px-4 max-w-5xl">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-slate-900 mb-2">Why CloudDesk for Rodtep-Scheme?</h2>
              <p className="text-slate-500">
                Most exporters lose 1-2% of their turnover because they don't know how to claim their scrips. CloudDesk ensures no rupee is left behind.
              </p>
            </div>
