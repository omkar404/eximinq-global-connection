...
const App = () => {
  ...
  // Clouddesk Launch:Mat 15, 2026
  const launchDate = new Date('May 15, 2026 09:00:00');
              ...
              <div className="flex flex-wrap gap-4 justify-center lg:justify-start">
                ...
                <div className="flex items-center space-x-4 px-6 border-l border-slate-200 ml-2">
                  <div className="text-left">
                    ...
                    <div className="text-[10px] font-bold text-blue-600 uppercase tracking-widest mt-1">SaaS Launch:Mat 15, 2026</div>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="flex flex-col lg:flex-row items-center gap-20">
            <div className="lg:w-1/2">
              ...
              <h2 className="text-5xl md:text-6xl font-black mt-6 mb-8 tracking-tighter leading-[0.9]">Clouddesk SaaS: <br />Launching <span className="text-blue-500">May 15, 2026</span></h2>
