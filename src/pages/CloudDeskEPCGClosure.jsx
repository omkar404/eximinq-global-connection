...
import { FileCheck } from "lucide-react"; // Using FileCheck icon for audit/services
import RequestAuditForm from "../components/CloudDeskEPCGClosure/RequestAuditForm";
export default function CloudDeskEPCGClosure() {
  const [setShowEnrollModal] = useState({
    open: false,
    type: "",
  });
    ...
    <div className="bg-slate-50 text-slate-800 antialiased selection:bg-teal-200 selection:text-teal-900">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16">
            ...
            <div className="lg:w-1/2">
              ...
              <p className="text-xl text-slate-600 mb-10 leading-relaxed max-w-xl font-light">
                Every month your EPCG license stays open, you pay bank
                commission fees and risk a demand notice with 15% interest. We
                retrieve EODCs and cancel bonds in{" "}
                <strong>45 days flat.</strong>
              </p>
            ...
            <div className="lg:w-1/2 relative">
              ...
              <div className="relative bg-white border border-slate-200 shadow-2xl rounded-3xl p-8 md:p-10 max-w-md mx-auto transform hover:-translate-y-2 transition duration-500">
                ...
                <p className="text-slate-600 leading-relaxed mb-8 text-sm">
                  We specialize in the "Hard Files"—licenses stuck due to lost
                  documents, excess imports, or block-wise defaults.
                </p>
                ...
                <div className="pt-6 border-t border-slate-100 flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-bold text-slate-900">45 Days</p>
                  </div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-slate-600 text-lg">
              The DGFT portal says "Under Process," but usually, it's one of
              these three technical errors blocking your money.
            </p>
          </div>
          ...
          <div className="flex flex-col md:flex-row gap-16 items-center">
            ...
            <div className="md:w-1/2">
              ...
              <p className="text-slate-600 text-lg mb-8">
                ...
                approach that clears technical errors before the file reaches
                the officer.
              </p>
                ...
                <table className="w-full text-left text-sm">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="py-4 text-slate-500">❌ Manual / Excel</td>
                    </tr>
      ...
      >
        ...
        <div className="max-w-7xl mx-auto px-4 text-center mb-12">
          ...
          <p className="text-slate-400 max-w-2xl mx-auto">
            Manual consultants lose files. Our SaaS platform ensures your
            documents are digitized, secure, and audit-ready forever.
          </p>
        </div>
      ...
      >
        ...
        <div className="max-w-6xl mx-auto px-4 relative z-10 flex flex-col lg:flex-row gap-16 items-center">
          ...
          <RequestAuditForm onSubmit={handleAuditSubmit} />
        </div>
      </section>
