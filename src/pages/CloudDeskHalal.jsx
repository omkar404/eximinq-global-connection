    ...
    <section id="about" className="py-20 bg-white">
        <div className="container mx-auto px-4 max-w-5xl">
            <div className="text-center mb-12">
                <h2 className="text-3xl font-bold text-slate-900 mb-4">What is Halal Certification?</h2>
                <div className="w-24 h-1 bg-accent-500 mx-auto rounded"></div>
            </div>
            <div className="prose lg:prose-lg mx-auto text-slate-600 text-justify">
                <p className="mb-4">
                    <strong>Halal</strong> is an Arabic word meaning "Permissible". Halal Certification is a guarantee that the product—whether food, pharmaceutical, or cosmetic—is manufactured in compliance with Islamic Sharia law. This means it does not contain any "Haram" (forbidden) ingredients (like pork, alcohol, or blood) and is prepared using dedicated equipment free from contamination.
                </p>
                [Image of Halal Process Flowchart]
                <p className="mb-4">
                    For exporters, this certificate acts as a <strong>Trade Passport</strong>. Countries like Saudi Arabia, UAE, Malaysia, and Indonesia enforce strict Halal regulations. Without a certificate from an accredited body, your shipment cannot clear customs in these nations.
                </p>
            </div>
        </div>
    </section>
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-4 gap-6">
          ...
          <div className="bg-white p-6 rounded-lg shadow border-t-4 border-pink-500 
                          text-center hover:-translate-y-2 transition">
            <div className="w-14 h-14 bg-pink-100 rounded-full flex items-center 
                            justify-center mx-auto mb-4">
          ...
          <div className="bg-white p-6 rounded-lg shadow border-t-4 border-orange-500 
                          text-center hover:-translate-y-2 transition">
            <div className="w-14 h-14 bg-orange-100 rounded-full flex items-center 
                            justify-center mx-auto mb-4">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-slate-600 mb-6">
              A certificate is only valuable if the importing country recognizes
              the Certification Body. We partner with top accredited agencies to
              ensure your certificate is valid globally.
            </p>
          ...
          <div className="bg-halal-50 p-8 rounded-xl border border-halal-200 text-center">
            ...
            <p className="text-sm text-slate-600">
              ...
              launched the i-CAS (Indian Conformity Assessment Scheme) for Halal.
              We help you navigate these domestic guidelines, especially for
              meat exports.
            </p>
          </div>
        ...
        <div className="container mx-auto px-4 grid md:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
                    <li><a href="#" class="hover:text-white transition">Food Certification</a></li>
                    <li><a href="#" class="hover:text-white transition">Cosmetics Certification</a></li>
                    <li><a href="#" class="hover:text-white transition">Pharma Certification</a></li>
                    <li><a href="#" class="hover:text-white transition">Meat Export License</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
                    <li><a href="#" class="hover:text-white transition">JAKIM Standards</a></li>
                    <li><a href="#" class="hover:text-white transition">MUI Regulations</a></li>
                    <li><a href="#" class="hover:text-white transition">Forbidden Ingredients</a></li>
                    <li><a href="#" class="hover:text-white transition">Halal Logos Guide</a></li>
            </ul>
          </div>
