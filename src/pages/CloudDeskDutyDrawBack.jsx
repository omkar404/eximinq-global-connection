  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Claim Duty Drawback under Section 74 (98% refund) and Brand Rate Fixation. Expert support for stuck drawback and re-export refunds."
        />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "@graph": [
              {
                "@type": "Service",
                "name": "Duty Drawback Consultancy",
                "provider": {
                  "@type": "Organization",
              ...
              },
              {
                ...
                "mainEntity": [
                  {
                    "@type": "Question",
                    "name": "What is Section 74 Duty Drawback?",
                    "acceptedAnswer": {
                      "@type": "Answer",
                      "text": "Section 74 allows refund of up to 98% of import duty paid when goods are re-exported within two years."
                    }
                  },
                  {
                    "@type": "Question",
                    "name": "When should I apply for a Brand Rate?",
                    "acceptedAnswer": {
                      "@type": "Answer",
                      "text": "Apply when the All Industry Rate is less than 80% of the actual duty paid on inputs."
                    }
                  },
                  {
                    "@type": "Question",
                    "name": "What if I re-export only a part of the shipment?",
                    "acceptedAnswer": {
                      "@type": "Answer",
                      "text": "You can claim a \"Pro-rata\" drawback. CloudDesk helps you map the specific serial numbers or batch numbers from the original Bill of Entry to the new Shipping Bill."
                    }
                  }
                ]
              },
