  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Apply for E-RCMC registration online in India. DGFT RCMC certificate for Export Promotion Councils (APEDA, EEPC, FIEO, CHEMEXCIL & more). Complete digital filing and EPC mapping support."
        />
        ...
        <meta
          property="og:title"
          content="E-RCMC Registration & EPC Mapping | Eximinq"
        />
        <meta
          property="og:description"
          content="Online RCMC registration under DGFT. Apply for APEDA, EEPC, FIEO, SEPC and 30+ Export Promotion Councils."
        />
        <meta
          property="og:url"
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Service",
            "name": "E-RCMC Registration Service",
            "serviceType": "E-RCMC Registration and Export Promotion Council (EPC) Mapping",
            "provider": {
              "@type": "Organization",
            ...
            "description":
              "Online E-RCMC registration and Export Promotion Council membership filing under DGFT Foreign Trade Policy.",
            "hasOfferCatalog": {
              "@type": "OfferCatalog",
              "name": "CloudDesk E-RCMC Services",
              "itemListElement": [
                {
                  "@type": "Offer",
                  "itemOffered": {
                    "@type": "Service",
                    "name": "Strategic EPC Mapping",
                    "description":
                      "HSN-based identification of the appropriate Export Promotion Council for RCMC registration."
                  }
                },
                {
                  "@type": "Offer",
                  "itemOffered": {
                    "@type": "Service",
                    "name": "DGFT-EPC Profile Synchronization",
                    "description":
                      "Validation of DGFT IEC profile and EPC membership data to prevent technical approval errors."
                  }
                },
                {
                  "@type": "Offer",
                  "itemOffered": {
                    "@type": "Service",
                    "name": "Incentive Advisory",
                    "description":
                      "Identification of eligible export incentive schemes after RCMC approval."
                  }
                },
                {
                  "@type": "Offer",
                  "itemOffered": {
                    "@type": "Service",
                    "name": "Membership Fee Optimization",
                    "description":
                      "Analysis of export turnover to determine correct EPC subscription slab."
                  }
                }
              ]
            }
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "mainEntity": [
              {
                "@type": "Question",
                "name": "Is RCMC mandatory for every exporter?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text":
                    "Technically, you can export without an RCMC. However, it is mandatory if you want to claim any benefit under the Foreign Trade Policy (FTP), such as duty remissions (RoDTEP), duty-free imports (Advance Auth), or even just to participate in an international trade fair at a subsidized rate."
                }
              },
              {
                "@type": "Question",
                "name": "I export both Spices and Engineering goods. Do I need two RCMCs?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text":
                    "You have two options: (1) Obtain separate RCMCs from the Spices Board and EEPC, or (2) Obtain a single \"Multi-Product\" RCMC from FIEO (Federation of Indian Export Organisations). CloudDesk evaluates your volume in each category to advise which path is more cost-effective."
                }
              },
              {
                "@type": "Question",
                "name": "What is the validity of an e-RCMC?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text":
                    "An RCMC is typically valid for 5 financial years. It begins on April 1st of the year it was issued and ends on March 31st of the fifth year. Note: You must still pay the \"Annual Membership Subscription\" to the council to keep it active."
                }
              },
              {
                "@type": "Question",
                "name": "Can I apply for RCMC without an IEC?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text":
                    "No. An active and updated IEC (Import-Export Code) is the absolute prerequisite. The e-RCMC application pulls all your company data directly from your IEC profile."
                }
              },
              {
                "@type": "Question",
                "name": "What is the \"ANF 2C\" form?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text":
                    "ANF 2C is the specific application form for RCMC. Under the new \"e-RCMC\" system, this form is completely digital on the DGFT portal. You no longer need to send physical papers to the council offices."
                }
              },
              {
                "@type": "Question",
                "name": "What documents are required for e-RCMC in 2026?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text":
              ...
              },
              {
                ...
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text":
                    "The fee consists of two parts: a one-time Admission Fee (usually ₹2,000 - ₹5,000) and an Annual Subscription based on your turnover (ranging from ₹6,000 to ₹75,000+). CloudDesk provides a fee-calculator based on your last year's FOB value."
                }
              },
              {
                "@type": "Question",
                "name": "What happens if my RCMC expires while my cargo is at sea?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text":
                    "You can still clear the goods, but you will not be able to claim the incentives (like RoDTEP) for that specific Shipping Bill. The system checks for a \"Valid RCMC\" at the time the Shipping Bill is generated. CloudDesk’s Expiry Shield prevents this by alerting you 60 days before the 5-year term ends."
                }
              },
            ]
          })}
      ...
      <div className="bg-slate-50 text-slate-800">
              ...
              <div className="overflow-x-auto max-h-[600px]">
                <table className="w-full text-sm text-left text-slate-600">
                  ...
                  <tbody className="divide-y divide-slate-100">
                    ...
                    <tr className="bg-white hover:bg-slate-50">
                      <td className="px-6 py-4 font-bold text-slate-800">Spices</td>
                      <td className="px-6 py-4">
                        Spices, Curry Powders, Spice Oils (Ch 09)
                      </td>
                      <td className="px-6 py-4">
                        <span className="text-brand-700 font-bold">Spices Board</span>
                      </td>
                    </tr>
                    <tr className="bg-white hover:bg-slate-50">
                      <td className="px-6 py-4 font-bold text-slate-800">
                      ...
                      <td className="px-6 py-4">Tea (Ch 0902) / Coffee (Ch 0901)</td>
                      <td className="px-6 py-4">
                    ...
                    <tr className="bg-slate-50 hover:bg-slate-100">
                      ...
                      <td className="px-6 py-4">
                        <span className="text-brand-700 font-bold">CHEMEXCIL</span>
                      </td>
                    </tr>
                    <tr className="bg-slate-50 hover:bg-slate-100">
                      <td className="px-6 py-4 font-bold text-slate-800">
                      ...
                      <td className="px-6 py-4">
                        <span className="text-brand-700 font-bold">PHARMEXCIL</span>
                      </td>
                    </tr>
                    <tr className="bg-slate-50 hover:bg-slate-100">
                      <td className="px-6 py-4 font-bold text-slate-800">Plastics</td>
                      <td className="px-6 py-4">
                        Polymers, Plastic Goods, Packaging (Ch 39)
                      </td>
                      <td className="px-6 py-4">
                        <span className="text-brand-700 font-bold">PLEXCONCIL</span>
                      </td>
                    </tr>
                    <tr className="bg-slate-50 hover:bg-slate-100">
                      <td className="px-6 py-4 font-bold text-slate-800">
                      ...
                      <td className="px-6 py-4">
                        <span className="text-brand-700 font-bold">CAPEXIL</span>
                      </td>
                    </tr>
                    ...
                    <tr className="bg-white hover:bg-slate-50">
                      ...
                      <td className="px-6 py-4">
                        <span className="text-brand-700 font-bold">EEPC India</span>
                      </td>
                    </tr>
                    <tr className="bg-white hover:bg-slate-50">
                      <td className="px-6 py-4 font-bold text-slate-800">
                      ...
                      <td className="px-6 py-4">
                        <span className="text-brand-700 font-bold">ESC / TEPC</span>
                      </td>
                    </tr>
                    ...
                    <tr className="bg-slate-50 hover:bg-slate-100">
                      ...
                      <td className="px-6 py-4">
                        <span className="text-brand-700 font-bold">TEXPROCIL</span>
                      </td>
                    </tr>
                    <tr className="bg-slate-50 hover:bg-slate-100">
                      <td className="px-6 py-4 font-bold text-slate-800">
                    ...
                    <tr className="bg-slate-50 hover:bg-slate-100">
                      <td className="px-6 py-4 font-bold text-slate-800">Handloom</td>
                      <td className="px-6 py-4">Handloom Fabrics and Products</td>
                      <td className="px-6 py-4">
                    ...
                    <tr className="bg-slate-50 hover:bg-slate-100">
                      <td className="px-6 py-4 font-bold text-slate-800">Carpets</td>
                      <td className="px-6 py-4">
                    ...
                    {/* <!-- Lifestyle & Others --> */}
                    <tr className="bg-white hover:bg-slate-50">
                      <td className="px-6 py-4 font-bold text-slate-800">Leather</td>
                      <td className="px-6 py-4">
                    ...
                    <tr className="bg-white hover:bg-slate-50">
                      ...
                      <td className="px-6 py-4">Sports Equipment, Toys (Ch 95)</td>
                      <td className="px-6 py-4">
                    ...
                    <tr className="bg-white hover:bg-slate-50">
                      ...
                      <td className="px-6 py-4">
                        <span className="text-brand-700 font-bold">SHEFEXIL</span>
                      </td>
                    </tr>
        ...
        <section className="py-20 bg-white">
          <div className="container mx-auto px-4 max-w-5xl">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-slate-900 mb-2">Why CloudDesk for E-RCMC Registration?</h2>
              <p className="text-slate-500">
                Most exporters pick the wrong council or fail the technical DGFT-EPC sync. CloudDesk ensures you are mapped to the council that gives you the most benefits
              </p>
            </div>
