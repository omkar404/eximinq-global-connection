          ...
          {JSON.stringify({
            ...
            "@graph": [
              ...
              },
              {
                "@type": "Service",
                serviceType:
                  "SCOMET licensing and export authorisation support",
          ...
          <div className="container mx-auto px-4 max-w-5xl">
            ...
            <div className="prose lg:prose-lg mx-auto text-slate-600 text-justify">
              <p className="mb-4">
                ...
                <strong>T</strong>echnologies. These are "dual-use" items,
                meaning they have civilian applications but can also be used for
                military purposes or in the production of Weapons of Mass
                Destruction (WMD).
              </p>
              <p className="mb-4">
                Under India's Foreign Trade Policy, the export of SCOMET items
                is either prohibited or permitted only under a license issued by
                the DGFT. This list is harmonized with global control regimes
                like the <strong>Wassenaar Arrangement</strong>,{" "}
              ...
              <div className="bg-red-50 border-l-4 border-red-500 p-6 mt-8 rounded-r-lg">
                ...
                <p className="text-sm">
                  ...
                  Systems (Prohibition of Unlawful Activities) Act, leading to
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="text-center mb-16">
              ...
              <p className="text-slate-300 mt-2 max-w-2xl mx-auto">
                Unlike standard licenses, SCOMET applications are reviewed by an
                Inter-Ministerial Working Group (IMWG) comprising DGFT, MEA,
                DRDO, and other security agencies.
              </p>
            </div>
            ...
            <div className="relative grid md:grid-cols-5 gap-8 step-connector">
              ...
              <div className="text-center relative z-10">
                ...
                <p className="text-sm text-slate-300">
                  Technical mapping of item specifications to the exact SCOMET
                  entry.
                </p>
              </div>
              ...
              <div className="text-center relative z-10">
                ...
                <p className="text-sm text-slate-300">
                  Obtaining End User Certificate (EUC) from the foreign buyer
                  (Appendix 2S).
                </p>
              </div>
              ...
              <div className="text-center relative z-10">
                ...
                <p className="text-sm text-slate-300">
                  Scrutiny by multiple ministries. Queries regarding end-use are
                  common.
                </p>
              </div>
            ...
            <div className="grid md:grid-cols-2 gap-16 items-center">
              ...
              <div>
                ...
                <p className="text-slate-600 mb-8">
                  Precision is key. A single error in the End User Certificate
          ...
          <div className="container mx-auto px-4 max-w-5xl">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-slate-900 mb-2">
                Why CloudDesk for Scomet-Licensing?
              </h2>
              <p className="text-slate-500">
                SCOMET isn't just paperwork; it’s a security clearance.
                CloudDesk ensures you don't end up on a global 'Denied Persons
                List'.
              </p>
            </div>
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="flex gap-4 p-6 bg-slate-50 rounded-xl border border-slate-100">
                ...
                <div>
                  <h4 className="font-bold text-slate-900 mb-2">
                    1. Technical Classification (The SCOMET Filter)
                  </h4>
                  <p className="text-sm text-slate-600 leading-relaxed">
                    Many exporters don't even know their product is restricted
                    <strong>
                      {" "}
                      (e.g., certain high-grade chemicals, drones, or
                      specialized software).
                    </strong>
                    <strong>CloudDesk </strong>performs a Deep-Technical Audit
                    of your product specifications against the
                    <strong> 8 SCOMET categories </strong>to determine if you
                    need a license.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-4 p-6 bg-slate-50 rounded-xl border border-slate-100">
                ...
                <div>
                  <h4 className="font-bold text-slate-900 mb-2">
                    2. End-User Credibility Check
                  </h4>
                  <p className="text-sm text-slate-600 leading-relaxed">
                    Customs doesn't just look at the product; they look at the
                    Buyer.<strong> CloudDesk </strong>conducts a Global Denied
                    Party Screening. We check your foreign buyer against
                    <strong> UN, US, and Indian </strong>watchlists before you
                    sign the contract, protecting you from
                    <strong> "Accidental Proliferation."</strong>
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-4 p-6 bg-slate-50 rounded-xl border border-slate-100">
                ...
                <div>
                  <h4 className="font-bold text-slate-900 mb-2">
                    3. IMWG Inter-Ministerial Coordination
                  </h4>
                  <p className="text-sm text-slate-600 leading-relaxed">
                    SCOMET licenses aren't issued by<strong> DGFT </strong>
                    alone. They are vetted by the
                    <strong> Inter-Ministerial Working Group (IMWG), </strong>
                    including representatives from
                    <strong> Defence, Space, and Atomic Energy.</strong>
                    <strong>CloudDesk </strong>manages the high-level technical
                    representations needed to convince these agencies that your
                    export is for peaceful use.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-4 p-6 bg-slate-50 rounded-xl border border-slate-100">
                ...
                <div>
                  <h4 className="font-bold text-slate-900 mb-2">
                    4. GAEC (Global Authorization) Optimization
                  </h4>
                  <p className="text-sm text-slate-600 leading-relaxed">
                    For regular exporters of certain
                    <strong>
                      {" "}
                      SCOMET items (like chemicals or electronics)
                    </strong>{" "}
                    to friendly nations, we help you secure the
                    <strong>
                      {" "}
                      Global Authorisation for Intra-Company Transfers (GAEC).
                    </strong>
                    This allows you to export multiple times to pre-approved
                    entities without applying for a fresh license every time.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <details className="bg-white p-6 rounded-lg shadow-sm border border-slate-200 group">
                ...
                <p className="text-sm text-slate-600 mt-4 leading-relaxed">
                  There are 9 categories (0 to 8) covering: Category 0: Nuclear
                  materials. Category 1: Toxic chemicals and agents. Category 2:
                  Micro-organisms/Toxins. Category 3: Materials/Material
                  Processing. Category 5: Aerospace/Avionics. Category 8:
                  Special Electronics and Computers (The most common category
                  for tech startups).
                </p>
              </details>
              ...
              <details className="bg-white p-6 rounded-lg shadow-sm border border-slate-200 group">
                <summary className="font-bold text-slate-800 cursor-pointer flex justify-between items-center">
                  My product is a simple commercial drone. Why is it under
                  SCOMET?
                  <ChevronDown
                    size={20}
                    className="text-brand-500 transition-transform group-open:rotate-180"
                ...
                <p className="text-sm text-slate-600 mt-4 leading-relaxed">
                  Because the same drone can be modified for surveillance or
                  payload delivery. In 2026, any hardware or software with
                  "strategic encryption" or "precision navigation" likely falls
                  under Category 5 or 8.
                </p>
              </details>
              ...
              <details className="bg-white p-6 rounded-lg shadow-sm border border-slate-200 group">
                ...
                <p className="text-sm text-slate-600 mt-4 leading-relaxed">
                  Yes. SCOMET isn't just for physical goods. If you are
                  "Transferring Technology" (via email, cloud, or training) to a
                  foreign entity that falls under the SCOMET description, you
                  need a license.
                </p>
              </details>
              ...
              <details className="bg-white p-6 rounded-lg shadow-sm border border-slate-200 group">
                ...
                <p className="text-sm text-slate-600 mt-4 leading-relaxed">
                  This is the most critical document. Your foreign buyer must
                  provide an Appendix 10B (EUC), legally promising that they
                  will not use the item for weapons and will not re-export it
                  without Indian government permission.
                </p>
              </details>
              ...
              <details className="bg-white p-6 rounded-lg shadow-sm border border-slate-200 group">
                ...
                <p className="text-sm text-slate-600 mt-4 leading-relaxed">
                  It is extremely difficult. The IMWG rarely approves licenses
                  for regions under UN embargo or active conflict. CloudDesk
                  provides a Country-Risk Report before you begin the
                  application.
                </p>
              </details>
              ...
              <details className="bg-white p-6 rounded-lg shadow-sm border border-slate-200 group">
                ...
                <p className="text-sm text-slate-600 mt-4 leading-relaxed">
                  Under the Foreign Trade (Development & Regulation) Act and the
                  WMD Act, 2005, the penalties include: (1) Heavy fines (into
                  crores), (2) Imprisonment (up to life in some cases), and (3)
                  Permanent cancellation of your IEC.
                </p>
              </details>
              ...
              <details className="bg-white p-6 rounded-lg shadow-sm border border-slate-200 group">
                ...
                <p className="text-sm text-slate-600 mt-4 leading-relaxed">
                  Because of the inter-ministerial vetting, it takes 45 to 90
                  days. CloudDesk’s "Filing-Accuracy" protocol ensures your
                  application isn't returned for queries, which is the #1 cause
                  of further delays.
                </p>
              </details>
              ...
              <details className="bg-white p-6 rounded-lg shadow-sm border border-slate-200 group">
                ...
                <p className="text-sm text-slate-600 mt-4 leading-relaxed">
                  Even if your item is NOT on the SCOMET list, if the government
                  suspects it is intended for a WMD program, they can stop the
                  shipment under "Catch-All" controls. CloudDesk helps you
                  document the "Peaceful End-Use" to mitigate this risk.
                </p>
              </details>
            </div>
          </div>
