  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="SCOMET license consultancy in India. Classification, End User Certificate, IMWG approval and DGFT export authorization support for dual-use items."
        />

        <link
          rel="canonical"
          href="https://eximinq.in/services/scomet-license"
        />

        <meta property="og:title" content="SCOMET License Consultancy in India" />
        <meta
          property="og:description"
          content="Apply for SCOMET export license with proper classification, EUC verification and IMWG coordination."
        />
        <meta
          property="og:url"
          content="https://eximinq.in/services/scomet-license"
        />
            ...
            "@graph": [
              {
                ...
                "itemListElement": [
                  ...
                  },
                  {
                    ...
                    "position": 3,
                    "name": "SCOMET License",
                    "item": "https://eximinq.in/services/scomet-license"
                  }
                ]
              },
              {
                "@type": "Service",
                "name": "SCOMET License Consultancy",
                "serviceType": "SCOMET Export Authorization",
                "description":
                  "Consultancy for SCOMET classification, EUC documentation, IMWG approval and DGFT export license filing.",
                "provider": {
                  "@type": "Organization",
              ...
              },
              {
                ...
                "mainEntity": [
                  {
                    "@type": "Question",
                    "name": "What are the main SCOMET Categories?",
                    "acceptedAnswer": {
                      "@type": "Answer",
                      "text": `There are 9 categories (0 to 8) covering:
                 ...
                 Category 8: Special Electronics and Computers (The most common category for tech startups).`
                  ...
                  {
                    "@type": "Question",
                    "name": "My product is a simple commercial drone. Why is it under SCOMET?",
                    "acceptedAnswer": {
                      "@type": "Answer",
                      "text": "Because the same drone can be modified for surveillance or payload delivery. In 2026, any hardware or software with \"strategic encryption\" or \"precision navigation\" likely falls under Category 5 or 8."
                    }
                  },
                  {
                    "@type": "Question",
                    "name": "Is software or technology also covered?",
                    "acceptedAnswer": {
                      "@type": "Answer",
                      "text": "Yes. SCOMET isn't just for physical goods. If you are \"Transferring Technology\" (via email, cloud, or training) to a foreign entity that falls under the SCOMET description, you need a license."
                    }
                  },
                  {
                    "@type": "Question",
                    "name": "What is an End-User Certificate (EUC)?",
                    "acceptedAnswer": {
                      "@type": "Answer",
                      "text": "This is the most critical document. Your foreign buyer must provide an Appendix 10B (EUC), legally promising that they will not use the item for weapons and will not re-export it without Indian government permission."
                    }
                  },
                  {
                    "@type": "Question",
                    "name": "Can I export SCOMET items to \"Conflict Zones\"?",
                    "acceptedAnswer": {
                      "@type": "Answer",
                      "text": "It is extremely difficult. The IMWG rarely approves licenses for regions under UN embargo or active conflict. CloudDesk provides a Country-Risk Report before you begin the application."
                    }
                  },
                  {
                    "@type": "Question",
                    "name": "What happens if I export a SCOMET item without a license?",
                    "acceptedAnswer": {
                      "@type": "Answer",
                      "text": "Under the Foreign Trade (Development & Regulation) Act and the WMD Act, 2005, the penalties include: (1) Heavy fines (into crores), (2) Imprisonment (up to life in some cases), and (3) Permanent cancellation of your IEC."
                    }
                  },
                  {
                    "@type": "Question",
                    "name": "How long does it take to get a SCOMET license?",
                    "acceptedAnswer": {
                      "@type": "Answer",
                      "text": "Because of the inter-ministerial vetting, it takes 45 to 90 days. CloudDesk’s \"Filing-Accuracy\" protocol ensures your application isn't returned for queries, which is the #1 cause of further delays."
                    }
                  },
                  {
                    "@type": "Question",
                    "name": "What is \"Catch-All\" control?",
                    "acceptedAnswer": {
                      "@type": "Answer",
                      "text": "Even if your item is NOT on the SCOMET list, if the government suspects it is intended for a WMD program, they can stop the shipment under \"Catch-All\" controls. CloudDesk helps you document the \"Peaceful End-Use\ to mitigate this risk."
                    }
                  },
                ]
              }
      ...
      <div className="bg-slate-50 text-slate-800">
        ...
        <section className="py-20 bg-white">
          <div className="container mx-auto px-4 max-w-5xl">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-slate-900 mb-2">Why CloudDesk for Scomet-Licensing?</h2>
