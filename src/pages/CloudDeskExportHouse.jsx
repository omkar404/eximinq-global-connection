 ...
 <section id="about" className="py-20 bg-white">
        <div className="container mx-auto px-4 max-w-5xl">
            <div className="text-center mb-12">
                <h2 className="text-3xl font-bold text-slate-900 mb-4">What is a Status Holder?</h2>
                <div className="w-24 h-1 bg-gold-500 mx-auto rounded"></div>
            </div>
            <div className="prose lg:prose-lg mx-auto text-slate-600 text-justify">
                <p className="mb-4">
                    The <strong>Status Holder</strong> certificate is a recognition granted by the Government of India to exporters who have demonstrated leadership in international trade and have contributed to the country's foreign exchange earnings.
                </p>
                [Image of Star Export House Logo]
                <p className="mb-4">
                    It is not just a badge of honor; it is a practical tool for ease of doing business. Exporters are categorized from <strong>One Star</strong> to <strong>Five Star</strong> based on their export performance (FOB value) over the current and previous three financial years.
                </p>
            </div>
        </div>
    </section>
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="mt-8 bg-green-50 border border-green-200 p-6 rounded-lg text-center max-w-4xl mx-auto">
          ...
          <p className="text-sm text-green-700">
            ...
            <strong> Double Weightage</strong>.  
            Exporting <strong>$1.5 Million</strong> qualifies for One Star
            (1.5 × 2 = 3 Million).
          </p>
        </div>
      </div>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="bg-white/10 p-6 rounded-xl backdrop-blur-sm border border-white/20 flex gap-4 hover:bg-white/20 transition">
            ...
            <div>
              ...
              <p className="text-sm text-slate-300">
                ...
                like Advance Authorisation and EPCG. Only a simple LUT
                is required.
              </p>
            </div>
          </div>
          ...
          <div className="bg-white/10 p-6 rounded-xl backdrop-blur-sm border border-white/20 flex gap-4 hover:bg-white/20 transition">
            ...
            <div>
              ...
              <p className="text-sm text-slate-300">
                ...
                of Origin (CoO). No need to visit agencies for every shipment.
              </p>
            </div>
          </div>
          ...
          <div className="bg-white/10 p-6 rounded-xl backdrop-blur-sm border border-white/20 flex gap-4 hover:bg-white/20 transition">
            ...
            <div>
              ...
              <p className="text-sm text-slate-300">
                ...
                Often treated as AEO-T1 equivalent for certain facilitations.
              </p>
            </div>
          </div>
          ...
          <div className="bg-white/10 p-6 rounded-xl backdrop-blur-sm border border-white/20 flex gap-4 hover:bg-white/20 transition">
            ...
            <div>
              ...
              <p className="text-sm text-slate-300">
                Permission to establish Export Warehouses as per
        ...
        <div className="relative grid md:grid-cols-4 gap-8 step-connector">
          <div className="text-center relative z-10">
            ...
            <p className="text-sm text-slate-500">
              Compile export data (e-BRCs) for the current and last 3 financial
              years.
            </p>
          </div>
        ...
        <div className="container mx-auto px-4 grid md:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
                    ...
                    <li><a href="#" class="hover:text-white transition">Status Holder</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
                   <li><a href="#" class="hover:text-white transition">FTP 2023 Guidelines</a></li>
                    ...
                    <li><a href="#" class="hover:text-white transition">Weightage Criteria</a></li>
                    <li><a href="#" class="hover:text-white transition">Certificate Validity</a></li>
            </ul>
          </div>
