...
const FAQS = [
  ...
  {
    question:
      "Can EXIMINQ help if my threshold calculation or records are unclear?",
    answer:
          ...
          <div className="container mx-auto px-4 max-w-5xl">
            ...
            <div className="prose lg:prose-lg mx-auto text-slate-600 text-justify">
              ...
              <p className="mb-4">
                ...
                their export performance (FOB value) over the current and
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="mt-8 bg-green-50 border border-green-200 p-6 rounded-lg text-center max-w-4xl mx-auto">
              ...
              <p className="text-sm text-green-700">
                MSME units, ISO certified units, and Agri/Fruit/Veg exporters
                get
                <strong> Double Weightage</strong>. Exporting{" "}
                <strong>$1.5 Million</strong> qualifies for One Star (1.5 × 2 =
                3 Million).
              </p>
            </div>
          </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="bg-white/10 p-6 rounded-xl backdrop-blur-sm border border-white/20 flex gap-4 hover:bg-white/20 transition">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-300">
                    Exemption from furnishing Bank Guarantee (BG) for schemes
                    like Advance Authorisation and EPCG. Only a simple LUT is
                    required.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white/10 p-6 rounded-xl backdrop-blur-sm border border-white/20 flex gap-4 hover:bg-white/20 transition">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-300">
                    Authority to self-certify the non-preferential Certificate
                    of Origin (CoO). No need to visit agencies for every
                    shipment.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white/10 p-6 rounded-xl backdrop-blur-sm border border-white/20 flex gap-4 hover:bg-white/20 transition">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-300">
                    Preferential treatment and faster clearance at Customs.
                    Often treated as AEO-T1 equivalent for certain
                    facilitations.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white/10 p-6 rounded-xl backdrop-blur-sm border border-white/20 flex gap-4 hover:bg-white/20 transition">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-300">
                    Permission to establish Export Warehouses as per Department
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="relative grid md:grid-cols-4 gap-8 step-connector">
              ...
              <div className="text-center relative z-10">
                ...
                <p className="text-sm text-slate-500">
                  DGFT issues the Status Holder Certificate electronically.
                  Valid for 5 years.
                </p>
              </div>
            </div>
          ...
          <div className="container mx-auto px-4 max-w-5xl">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-slate-900 mb-2">
                Why CloudDesk for Star-Export-House?
              </h2>
              <p className="text-slate-500">
                Reaching $3 Million is only half the battle. Proving it to the
                DGFT's automated system is where the errors happen.
              </p>
            </div>
            <div className="grid md:grid-cols-2 gap-8">
              {/* Feature 1 */}
              <div className="flex gap-4 p-6 bg-slate-50 rounded-xl border border-slate-100">
                ...
                <div>
                  <h4 className="font-bold text-slate-900 mb-2">
                    1. The "Double Weightage" Optimization
                  </h4>
                  <p className="text-sm text-slate-600 leading-relaxed">
                    If you are an MSME, a Manufacturing unit with{" "}
                    <strong>ISO/BIS,</strong> or located in the North East, your
                    exports count as 2x for the 1-Star Status.
                    <strong>CloudDesk’s</strong>Weightage Calculator
                    automatically identifies these{" "}
                    <strong>"Bonus Points," </strong>
                    helping you achieve 1-Star Status with just $1.5 Million in
                    actual exports instead of $3 Million.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-4 p-6 bg-slate-50 rounded-xl border border-slate-100">
                ...
                <div>
                  <h4 className="font-bold text-slate-900 mb-2">
                    2. Automated Export Data Scrubbing
                  </h4>
                  <p className="text-sm text-slate-600 leading-relaxed">
                    The <strong>DGFT portal</strong> auto-populates data from
                    your <strong>Shipping Bills,</strong> but it often misses
                    Service Exports or Deemed Exports.
                    <strong>CloudDesk </strong>performs a Manual vs. System
                    Audit to ensure every dollar of your foreign exchange is
                    counted, preventing you from missing a star category by a{" "}
                    <strong>few thousand dollars.</strong>
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-4 p-6 bg-slate-50 rounded-xl border border-slate-100">
                ...
                <div>
                  <h4 className="font-bold text-slate-900 mb-2">
                    3. Bank Guarantee (BG) Waiver Lock
                  </h4>
                  <p className="text-sm text-slate-600 leading-relaxed">
                    The biggest benefit of Star Status is the 100% exemption
                    from Bank Guarantees for{" "}
                    <strong>DGFT schemes (EPCG, Advance Auth).</strong>
                    <strong>CloudDesk’s </strong>dashboard links your Status
                    Certificate directly to your license applications, ensuring
                    the "BG Waiver" is applied automatically so your capital
                    stays in your bank, not blocked in a FD.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-4 p-6 bg-slate-50 rounded-xl border border-slate-100">
                ...
                <div>
                  <h4 className="font-bold text-slate-900 mb-2">
                    4. Self-Certification Empowerment
                  </h4>
                  <p className="text-sm text-slate-600 leading-relaxed">
                    For 3-Star Houses and above, you can self-certify your{" "}
                    <strong>Certificate of Origin. </strong>
                    CloudDesk provides the digital template and compliance log
                    for this, allowing you to ship goods without waiting for a
            ...
            <div className="space-y-4">
              ...
              <details className="bg-white p-6 rounded-lg shadow-sm border border-slate-200 group">
                ...
                <p className="text-sm text-slate-600 mt-4 leading-relaxed">
                  "• One Star: US$ 3 Million • Two Star: US$ 15 Million • Three
                  Star: US$ 50 Million • Four Star: US$ 200 Million • Five Star:
                  US$ 800 Million"
                </p>
              </details>
              ...
              <details className="bg-white p-6 rounded-lg shadow-sm border border-slate-200 group">
                ...
                <p className="text-sm text-slate-600 mt-4 leading-relaxed">
                  No. You must show performance in at least 2 out of the last 4
                  years (including the current year). CloudDesk helps you pick
                  the "Best 2 Years" to maximize your chances.
                </p>
              </details>
              ...
              <details className="bg-white p-6 rounded-lg shadow-sm border border-slate-200 group">
                ...
                <p className="text-sm text-slate-600 mt-4 leading-relaxed">
                  No. Double weightage (counting $1 as $2) is strictly for
                  achieving the One Star status. For Two Star and above, only
                  actual FOB value is counted.
                </p>
              </details>
              ...
              <details className="bg-white p-6 rounded-lg shadow-sm border border-slate-200 group">
                ...
                <p className="text-sm text-slate-600 mt-4 leading-relaxed">
                  Normally, for schemes like EPCG, you must give the government
                  a Bank Guarantee (100% of the duty saved). Status Holders are
                  exempted 100% from this requirement (unless specifically
                  flagged as a risk), saving you lakhs in bank commissions and
                  blocked margins.
                </p>
              </details>
              ...
              <details className="bg-white p-6 rounded-lg shadow-sm border border-slate-200 group">
                ...
                <p className="text-sm text-slate-600 mt-4 leading-relaxed">
                  Two Star Houses and above are permitted to establish export
                  warehouses as per Dept. of Revenue guidelines. This is a
                  game-changer for managing global supply chains.
                </p>
              </details>
              ...
              <details className="bg-white p-6 rounded-lg shadow-sm border border-slate-200 group">
                ...
                <p className="text-sm text-slate-600 mt-4 leading-relaxed">
                  In 2026, Status Holders are expected to mentor new
                  entrepreneurs. A 2-Star House must train 5 candidates
                  annually, while a 5-Star House must train 50. CloudDesk helps
                  you document this training to ensure your status remains valid
                  during renewal.
                </p>
              </details>
              ...
              <details className="bg-white p-6 rounded-lg shadow-sm border border-slate-200 group">
                ...
                <p className="text-sm text-slate-600 mt-4 leading-relaxed">
                  It is valid for 5 years or until the end of the current
                  Foreign Trade Policy, whichever is earlier. CloudDesk monitors
                  the "Policy Sunset" dates so you don't lose your status during
                  a policy transition.
                </p>
              </details>
              ...
              <details className="bg-white p-6 rounded-lg shadow-sm border border-slate-200 group">
                ...
                <p className="text-sm text-slate-600 mt-4 leading-relaxed">
                  (1) Defaulting on an Export Obligation (EPCG/Advance Auth),
                  (2) Mis-declaration of export values, (3) Fraudulent CA
                  certificates. CloudDesk’s Audit Log keeps your records clean
                  so you never face a "Show Cause Notice."
                </p>
              </details>
            </div>
          </div>
