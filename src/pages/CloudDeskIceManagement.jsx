  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Apply for Import Export Code (IEC) online in India. DGFT IEC registration, modification, annual update, and compliance support with expert assistance."
        />
        ...
        <meta
          property="og:title"
          content="IEC Registration Online in India | Eximinq"
        />
        <meta
          property="og:description"
          content="DGFT Import Export Code registration, annual update, and IEC modification services across India."
        />
        <meta
          property="og:url"
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "areaServed": "India",
            "description":
              "Import Export Code (IEC) registration, modification and annual compliance filing services under DGFT."
          })}
        </script>
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "mainEntity": [
              {
                "@type": "Question",
                "name": "Is IEC Registration valid for a lifetime?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text":
                    "Yes, IEC is valid for a lifetime and does not require renewal. However, annual updation of details on the DGFT portal is mandatory between April and June every year."
                }
              },
              {
                "@type": "Question",
                "name": "Can an individual apply for IEC?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text":
                    "Yes, individuals (Proprietors) can obtain an IEC code in their name or their firm's name. It is equally applicable to companies, LLPs, and partnerships."
                }
              },
              {
                "@type": "Question",
                ...
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text":
                    "Generally, the IEC code is generated within 1 to 3 working days after the successful submission of documents and fees. In many cases, it is issued instantly."
                }
              },
              {
                "@type": "Question",
                "name": "Is digital signature (DSC) mandatory?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text":
                    "For companies and LLPs, a Digital Signature Certificate (DSC) is mandatory. For proprietorships, the application can often be validated using Aadhaar e-sign."
                }
              },
              {
                "@type": "Question",
              ...
              {
                "@type": "Question",
                "name": "My IEC is linked to an old Director's mobile number/email. How do I recover it?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text":
                    "UsuThis is a high-risk situation. CloudDesk assists in the \"Email/Mobile Change\" process, which involves validating the new signatory via a Class 3 DSC and updating the profile. We ensure you don't lose access to your digital trade identity."
                }
              },
              {
                "@type": "Question",
                "name": "Can I have two IECs for the same PAN?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text":
                    "Strictly No. One PAN, One IEC. If you have inadvertently obtained two, you must surrender one immediately. Holding dual IECs is a violation of the Foreign Trade Policy and can lead to your PAN being blacklisted."
                }
              },
              {
                "@type": "Question",
                "name": "We are changing our firm from a Proprietorship to a Private Limited. Can we keep the same IEC?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text":
                    "Yes, but it requires a \"Constitution Change\" modification. You must update the PAN associated with the IEC. This is a complex process because it involves migrating your history and benefits to the new entity. CloudDesk handles the legal drafting for this transition."
                }
              },
              {
                "@type": "Question",
                "name": "Does my Bank need to do anything once my IEC is updated?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text":
                    "In most cases, the bank's system (AD Bank) should automatically pick up the update via the EDPMS (Export Data Processing and Monitoring System). However, we recommend sending the updated IEC profile to your bank's Forex department to ensure there are no delays in realizing export proceeds."
                }
              },
              {
                "@type": "Question",
                "name": "The DGFT portal says \"Data Mismatch with PAN.\" What do I do?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text":
                    "This happens when the name on your PAN card (even a single dot or space) doesn't exactly match the name entered in the DGFT system. CloudDesk performs a Character-by-Character Audit to fix these discrepancies so your application gets approved instantly."
                }
              },
            ]
          })}
