          ...
          <div class="container mx-auto px-4 max-w-5xl">
            ...
            <div class="prose lg:prose-lg mx-auto text-slate-600 text-justify">
              ...
              <p class="mb-4">
                ...
                export without obtaining an IEC. Unlike other government
                licenses, the IEC generally does not need to be renewed, but its
                details must be updated annually on the DGFT portal to keep the
                code active.
              </p>
                ...
                <div className="flex gap-4 items-start">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-600">
                      ...
                      through Indo-Myanmar border areas and China (through
                      Gunji, Namgaya Shipkila and Nathula ports) provided CIF
                      value of a single consignment does not exceed ₹25,000.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="container mx-auto px-4 max-w-5xl">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-slate-900 mb-2">
                Why CloudDesk for IEC Management?
              </h2>
              <p className="text-slate-500">
                Eliminate compliance risks with automated DGFT & Customs
                monitoring.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="flex gap-4 p-6 bg-slate-50 rounded-xl border border-slate-100">
                ...
                <div>
                  <h4 className="font-bold text-slate-900 mb-2">
                    1. Elimination of "The July Surprise"
                  </h4>
                  <p className="text-sm text-slate-600 leading-relaxed">
                    Every year on July 1st, thousands of exporters realize their{" "}
                    <strong>IEC is deactivated</strong> because they missed the
                    June 30th update deadline.
                    <strong>CloudDesk</strong> eliminates this. Our system syncs
                    with the DGFT server API to monitor your "Last Updated"
                    timestamp. We start automated reminders on April 1st and can
                    auto-file your "No-Change" confirmation in seconds.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-4 p-6 bg-slate-50 rounded-xl border border-slate-100">
                ...
                <div>
                  <h4 className="font-bold text-slate-900 mb-2">
                    2. Cross-Platform Data Harmony
                  </h4>
                  <p className="text-sm text-slate-600 leading-relaxed">
                    <strong>Customs (ICEGATE)</strong> and <strong>DGFT</strong>{" "}
                    are two different systems. Often, an update on DGFT doesn't
                    "push" to ICEGATE, causing a "PAN Not Found" error at the
                    port. CloudDesk’s Technical Bridge verifies that your update
                    has successfully transitioned to the Customs server before
                    you ship your next container.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-4 p-6 bg-slate-50 rounded-xl border border-slate-100">
                ...
                <div>
                  <h4 className="font-bold text-slate-900 mb-2">
                    3. Entity-Level Document Hierarchy
                  </h4>
                  <p className="text-sm text-slate-600 leading-relaxed">
                    If you have <strong>multiple branches</strong>, keeping
                    track of which address proof is linked to which branch in
                    the DGFT records is a nightmare. CloudDesk organizes your
                    IEC data by Branch Code, allowing you to update specific
                    locations without messing up the primary registration.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-4 p-6 bg-slate-50 rounded-xl border border-slate-100">
                ...
                <div>
                  <h4 className="font-bold text-slate-900 mb-2">
                    4. Security & Permission Control
                  </h4>
                  <p className="text-sm text-slate-600 leading-relaxed">
                    Stop giving your master <strong>DGFT password</strong> to
                    every junior accountant or external consultant. CloudDesk
                    allows you to manage your compliance without sharing
                    sensitive login credentials, protecting your business from
          ...
          <div className="container mx-auto px-4 max-w-3xl">
            ...
            <div className="space-y-4">
              ...
              <details className="bg-white p-6 rounded-lg shadow-sm border border-slate-200 group">
                ...
                <p className="text-sm text-slate-600 mt-4 leading-relaxed">
                  Generally, the IEC code is generated within 1 to 3 working
                  days after the successful submission of documents and fees. In
                  many cases, it is issued instantly.
                </p>
              </details>
              ...
              <details className="bg-white p-6 rounded-lg shadow-sm border border-slate-200 group">
                ...
                <p className="text-sm text-slate-600 mt-4 leading-relaxed">
                  For companies and LLPs, a Digital Signature Certificate (DSC)
                  is mandatory. For proprietorships, the application can often
                  be validated using Aadhaar e-sign.
                </p>
              </details>
              ...
              <details className="bg-white p-6 rounded shadow-sm border border-slate-200 group">
                <summary className="font-bold text-slate-800 cursor-pointer flex justify-between items-center">
                  I have made no changes to my company this year. Do I still
                  need to update my IEC?
                  <ChevronDown
                    size={20}
                    className="text-brand-500 transition-transform group-open:rotate-180"
                  />
              ...
              <details className="bg-white p-6 rounded shadow-sm border border-slate-200 group">
                ...
                <p className="text-sm text-slate-600 mt-4 leading-relaxed">
                  Usually, the DGFT issues a public notice extending it
                  slightly, but legally, deactivation begins on July 1st. Once
                  deactivated, you cannot even generate a draft Shipping Bill.
                </p>
              </details>

              <details className="bg-white p-6 rounded shadow-sm border border-slate-200 group">
                <summary className="font-bold text-slate-800 cursor-pointer flex justify-between items-center">
                  My IEC is linked to an old Director's mobile number/email. How
                  do I recover it?
                  <ChevronDown
                    size={20}
                    className="text-brand-500 transition-transform group-open:rotate-180"
                ...
                <p className="text-sm text-slate-600 mt-4 leading-relaxed">
                  This is a high-risk situation. CloudDesk assists in the
                  "Email/Mobile Change" process, which involves validating the
                  new signatory via a Class 3 DSC and updating the profile. We
                  ensure you don't lose access to your digital trade identity.
                </p>
              </details>
              ...
              <details className="bg-white p-6 rounded shadow-sm border border-slate-200 group">
                ...
                <p className="text-sm text-slate-600 mt-4 leading-relaxed">
                  Strictly No. One PAN, One IEC. If you have inadvertently
                  obtained two, you must surrender one immediately. Holding dual
                  IECs is a violation of the Foreign Trade Policy and can lead
                  to your PAN being blacklisted.
                </p>
              </details>

              <details className="bg-white p-6 rounded shadow-sm border border-slate-200 group">
                <summary className="font-bold text-slate-800 cursor-pointer flex justify-between items-center">
                  We are changing our firm from a Proprietorship to a Private
                  Limited. Can we keep the same IEC?
                  <ChevronDown
                    size={20}
                    className="text-brand-500 transition-transform group-open:rotate-180"
                  />
                ...
                <p className="text-sm text-slate-600 mt-4 leading-relaxed">
                  Yes, but it requires a "Constitution Change" modification. You
                  must update the PAN associated with the IEC. This is a complex
                  process because it involves migrating your history and
                  benefits to the new entity. CloudDesk handles the legal
                  drafting for this transition.
                </p>
              </details>
              ...
              <details className="bg-white p-6 rounded shadow-sm border border-slate-200 group">
                ...
                <p className="text-sm text-slate-600 mt-4 leading-relaxed">
                  In most cases, the bank's system (AD Bank) should
                  automatically pick up the update via the EDPMS (Export Data
                  Processing and Monitoring System). However, we recommend
                  sending the updated IEC profile to your bank's Forex
                  department to ensure there are no delays in realizing export
                  proceeds.
                </p>
              </details>
              ...
              <details className="bg-white p-6 rounded shadow-sm border border-slate-200 group">
                ...
                <p className="text-sm text-slate-600 mt-4 leading-relaxed">
                  This happens when the name on your PAN card (even a single dot
                  or space) doesn't exactly match the name entered in the DGFT
                  system. CloudDesk performs a Character-by-Character Audit to
                  fix these discrepancies so your application gets approved
                  instantly.
                </p>
              </details>
            </div>
