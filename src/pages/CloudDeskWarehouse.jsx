          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <div className="bg-slate-50 rounded-xl shadow-md p-8 border-t-4 border-brand-800 hover:shadow-xl transition">
                ...
                <p className="text-sm text-slate-600">
                  Licensed only to store dutiable imported goods belonging to
                  the <strong>license holder</strong>. Ideal for manufacturers
                  or large distribution hubs.
                </p>
              ...
              <div className="bg-slate-50 rounded-xl shadow-md p-8 border-t-4 border-green-600 hover:shadow-xl transition">
                ...
                <p className="text-sm text-slate-600">
                  ...
                  without paying duty upfront. Duty applies only on clearance.
                </p>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              <div className="bg-white text-slate-800 p-6 rounded-xl shadow-lg border-t-4 border-brand-500 text-center">
                <CalendarClock
                  className="text-brand-600 mx-auto mb-3"
                  size={32}
                />
                <h3 className="font-bold text-lg mb-2">Duty Deferment</h3>
                <p className="text-sm text-slate-600">
                  Pay customs duty only when goods are cleared for domestic
                  consumption.
                </p>
              </div>
              ...
              <div className="bg-white text-slate-800 p-6 rounded-xl shadow-lg border-t-4 border-brand-500 text-center">
                ...
                <h3 className="font-bold text-lg mb-2">Duty-Free Re-Export</h3>
                <p className="text-sm text-slate-600">
              ...
              <div className="bg-white text-slate-800 p-6 rounded-xl shadow-lg border-t-4 border-brand-500 text-center">
                ...
                <p className="text-sm text-slate-600">
                  Minor processing, labeling, kitting, or assembly is permitted
                  under bond.
                </p>
              </div>
              ...
              <div className="bg-white text-slate-800 p-6 rounded-xl shadow-lg border-t-4 border-brand-500 text-center">
                ...
                <p className="text-sm text-slate-600">
                  Updated regulations simplify record-keeping and significantly
                  reduce bank guarantee requirements.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="relative grid md:grid-cols-5 gap-8">
              ...
              <div className="text-center relative z-10">
                ...
                <p className="text-sm text-slate-500">
                  File the application online with the Principal Commissioner of
                  Customs (PCC).
                </p>
              </div>
              ...
              <div className="text-center relative z-10">
                ...
                <p className="text-sm text-slate-500">
                  Customs officers inspect the premises for security, access
              ...
              <div className="text-center relative z-10">
                ...
                <p className="text-sm text-slate-500">
                  Execute a Continuity Bond covering the potential customs duty
              ...
              <div className="text-center relative z-10">
                ...
                <p className="text-sm text-slate-500">
                  PCC issues the formal warehouse license (Form B / C / D),
              ...
              <div className="text-center relative z-10">
                ...
                <p className="text-sm text-slate-500">
                  Begin filing Bills of Entry (into Bond) and maintain daily
                  statutory records.
                </p>
              </div>
            </div>
          ...
          <div className="container mx-auto px-4 max-w-5xl">
            <div className="text-center mb-12">
              ...
              <p className="text-slate-500">
                A warehouse is more than a shed; in 2026, it is a "Tax-Free
                Zone" if licensed correctly.
              </p>
            </div>
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="flex gap-4 p-6 bg-slate-50 rounded-xl border border-slate-100">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-600 leading-relaxed">
                    We help you set up a{" "}
                    <strong>Private Bonded Warehouse</strong>. This allows you
                    to import bulk cargo and keep it in your facility{" "}
                    <strong>without paying 100% Import Duty upfront</strong>.
                    You only pay duty as and when you remove goods for sale.
                    CloudDesk manages the <strong>Double Duty Bond</strong> and
                    the digital ledger required by Customs.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-4 p-6 bg-slate-50 rounded-xl border border-slate-100">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-600 leading-relaxed">
                    If you deal in commodities, we register you with the{" "}
                    <strong>
                      Warehousing Development and Regulatory Authority (WDRA)
                    </strong>
                    . This turns your warehouse receipts into{" "}
                    <strong>Negotiable Instruments (e-NWRs)</strong>, allowing
                    you to get instant bank funding against your stored
                    inventory.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-4 p-6 bg-slate-50 rounded-xl border border-slate-100">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-600 leading-relaxed">
                    The <strong>MOOWR 2019/2026 scheme</strong> is a
                    game-changer. CloudDesk licenses your warehouse as a{" "}
                    <strong>"Manufacturing Unit"</strong> where you can import
                    raw materials duty-free, manufacture, and only pay duty on
                    the final product if sold in India — or{" "}
                    <strong>zero duty if exported</strong>.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-4 p-6 bg-slate-50 rounded-xl border border-slate-100">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-600 leading-relaxed">
                    For chemicals or pharma, a standard license isn't enough. We
                    manage the{" "}
                    <strong>
                      Fire Department NOC, Pollution Board CTE/CTO,
                    </strong>{" "}
                    and <strong>Industrial Safety (DISH) approvals</strong>{" "}
                    specifically for specialized storage, ensuring you meet the
                    2026 safety mandates for{" "}
                    <strong>"High-Risk Storage."</strong>
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <details className="bg-white p-6 rounded-lg shadow-sm border border-slate-200 group">
                <summary className="font-bold text-slate-800 cursor-pointer flex justify-between items-center">
                  What is the difference between Section 57 and Section 58
                  warehouses?
                  <ChevronDown
                ...
                <p className="text-sm text-slate-600 mt-4 leading-relaxed">
                  • <strong>Section 57 (Public):</strong> Operated by the
                  government or authorized agencies (like CWC). Anyone can store
                  goods here.
                  <br />• <strong>Section 58 (Private):</strong> Your own
                  facility licensed to store your imported goods without
              ...
              <details className="bg-white p-6 rounded-lg shadow-sm border border-slate-200 group">
                ...
                <p className="text-sm text-slate-600 mt-4 leading-relaxed">
                  In 2026, the initial period is{" "}
                  <strong>one year, extendable by the Commissioner</strong>.
                  However, for capital goods (machinery), you can often store
                  them until they are cleared for home consumption.
                </p>
              </details>
              ...
              <details className="bg-white p-6 rounded-lg shadow-sm border border-slate-200 group">
                ...
                <p className="text-sm text-slate-600 mt-4 leading-relaxed">
                  Yes. Storage and handling charges attract{" "}
                  <strong>18% GST</strong>. However, the sale of goods within a
                  bonded warehouse to another buyer is treated as a{" "}
                  <strong>"no-supply" under Schedule III (Tax-Free)</strong>{" "}
                  until the goods are cleared for home consumption.
                </p>
              </details>
              ...
              <details className="bg-white p-6 rounded-lg shadow-sm border border-slate-200 group">
                ...
                <p className="text-sm text-slate-600 mt-4 leading-relaxed">
                  Yes. If you store food items, you must have an FSSAI
                  Registration/License specifically for the{" "}
                  <strong>"Storage/Warehouse" category</strong>. A manufacturing
                  license is <strong>not enough</strong> for a standalone
                  storage site.
                </p>
              </details>
              ...
              <details className="bg-white p-6 rounded-lg shadow-sm border border-slate-200 group">
                ...
                <p className="text-sm text-slate-600 mt-4 leading-relaxed">
                  Customs and WDRA mandate that the warehouse must be insured
                  for <strong>Fire, Flood, Theft, and Burglary</strong>. In
                  2026, the policy must also cover the{" "}
                  <strong>Duty Amount of the stored goods</strong>, not just
                  their value.
                </p>
              </details>
              ...
              <details className="bg-white p-6 rounded-lg shadow-sm border border-slate-200 group">
                ...
                <p className="text-sm text-slate-600 mt-4 leading-relaxed">
                  Yes, under <strong>Section 64 (Owner's Right)</strong>. You
                  can sort, pack, or relabel goods in a bonded warehouse{" "}
                  <strong>under Customs supervision</strong>. This is ideal for
                  meeting <strong>LMPC (Legal Metrology)</strong> labeling
                  requirements before final clearance.
                </p>
              </details>
              ...
              <details className="bg-white p-6 rounded-lg shadow-sm border border-slate-200 group">
                ...
                <p className="text-sm text-slate-600 mt-4 leading-relaxed">
                  ...
                  <strong>Full Duty + Interest + Penalties</strong>. The{" "}
                  <strong>"Warehouse Keeper"</strong> is personally responsible
                  for any shortage in the digital stock ledger.
                </p>
              </details>
              ...
              <details className="bg-white p-6 rounded-lg shadow-sm border border-slate-200 group">
                ...
                <p className="text-sm text-slate-600 mt-4 leading-relaxed">
                  In 2026, manual registers are illegal. You must maintain a{" "}
                  <strong>Cloud-Based Inventory System</strong> that is
                  accessible by Customs officers for{" "}
                  <strong>real-time audits</strong>. CloudDesk provides the
                  software integration for this ledger.
                </p>
              </details>
            </div>
          </div>
