  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Apply for Certificate of Origin (Preferential & Non-Preferential). FTA eligibility, Rules of Origin validation, and digital e-CoO filing support."
        />
            ...
            "@graph": [
              ...
              },
              {
                ...
                "mainEntity": [
                  {
                    "@type": "Question",
                    "name": "What is the difference between Preferential and Non-Preferential CoO?",
                    "acceptedAnswer": {
                      "@type": "Answer",
                      "text": "Preferential CoO allows reduced or zero duty under trade agreements. Non-Preferential CoO only certifies origin without duty benefit."
                    }
                  },
                  {
                    "@type": "Question",
                    "name": "How do I know if my product qualifies for an FTA?",
                    "acceptedAnswer": {
                      "@type": "Answer",
                      "text": "Yes (Retrospective Issuance). In 2026, you can apply for a CoO retrospectively, but it must be clearly marked as \"ISSUED RETROSPECTIVELY\" and usually requires an explanation for the delay."
                    }
                  },
                  {
                    "@type": "Question",
                    "name": "Is a physical copy of the CoO required in 2026?",
                    "acceptedAnswer": {
                      "@type": "Answer",
                      "text": "Generally, No. Most 2026 treaties allow for Digital CoOs with a QR code for verification. However, for some countries (like those in the Middle East or Latin America), a physical \"Wet-Ink\" stamp from the Chamber of Commerce may still be requested by the bank."
                    }
                  }
                ]
              },
      ...
      <div className="bg-slate-50 text-slate-800">
        ...
        <section className="bg-gradient-to-br from-slate-900 to-slate-800 py-16 px-4">
          <div className="max-w-6xl mx-auto text-center">
            ...
            <div className="grid md:grid-cols-3 gap-8 items-stretch">
              ...
              <div className="bg-white rounded-xl shadow-lg p-8 flex flex-col">
                ...
                <p className="text-2xl font-bold text-slate-900">
                  ₹25,000 <span className="text-base text-slate-600">/ mo</span>
                </p>

                <p className="text-sm text-slate-500 mt-2 mb-6">
                  Up to 30 Pref. COOs <br />
                  <span className="text-xs">(Extra COOs billed separately)</span>
                </p>
                ...
                <button
                  ...
                  className="mt-6 bg-slate-900 text-white py-2 px-6 rounded-md font-semibold hover:bg-slate-700 transition">
                  Enroll Now
                </button>
              </div>

              {/* Mid Plan (Highlighted) */}
              <div className="relative bg-blue-600 text-white rounded-xl shadow-2xl p-8 flex flex-col scale-105">

                <span className="absolute -top-3 right-6 bg-white text-blue-600 text-xs font-bold px-3 py-1 rounded-full shadow">
                  Best Value
                </span>
                ...
                <p className="text-3xl font-bold">
                  ₹50,000 <span className="text-base">/ mo</span>
                </p>

                <p className="text-sm mt-2 mb-6">
                  Up to 75 Pref. COOs <br />
                  <span className="text-xs">(Extra COOs billed separately)</span>
                </p>
                ...
                <button
                  ...
                  className="mt-6 bg-white text-blue-600 py-2 px-6 rounded-md font-semibold hover:bg-blue-50 transition">
                  Enroll Now
                </button>
              </div>
              ...
              <div className="bg-white rounded-xl shadow-lg p-8 flex flex-col">
                ...
                <p className="text-2xl font-bold text-slate-900">
                  ₹75,000 <span className="text-base text-slate-600">/ mo</span>
                </p>

                <p className="text-sm text-slate-500 mt-2 mb-6">
                  Up to 100 Pref. COOs <br />
                  <span className="text-xs">(Extra COOs billed separately)</span>
                </p>
            ...
            {/* Bonus */}
            <div className="mt-10">
              <div className="inline-block bg-green-600 text-white text-sm font-semibold px-6 py-3 rounded-lg shadow-md">
            ...
            {/* Billing Note */}
            <div className="mt-6">
              <div className="inline-block bg-slate-700 text-slate-200 text-sm px-6 py-3 rounded-lg">
        ...
        <section className="py-20 bg-white">
          <div className="container mx-auto px-4 max-w-5xl">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="flex gap-4 p-6 bg-blue-100 rounded-xl border border-slate-100">
                <div className="bg-green-100 p-3 rounded-lg text-green-600 h-fit">
                  <IndianRupee size={24} />
                </div>

                {/* Make this column layout */}
                <div className="flex flex-col flex-1">
                  <div>
                    ...
                    <p className="text-sm text-slate-600 leading-relaxed">
                      <strong>Issuing a Certificate of Origin (CoO)</strong> is not the end of the transaction;
                      it’s the beginning of your legal liability. <strong>CloudDesk</strong> implements a Verification Guard system that
                      cross-references your shipping documents
                      (Shipping Bills, Invoices, and Bill of Lading) against the issued CoO to eliminate discrepancies.
                      We ensure that your <strong>HSN codes</strong> and <strong>descriptions</strong> remain consistent across all jurisdictions, preventing customs seizures,
                      <strong>blacklisting,</strong> or <strong>heavy penalties</strong> resulting from clerical <strong>mismatches</strong> or <strong>"mis-declaration"</strong> of origin.
                    </p>
                  </div>
            ...
            <div className="space-y-4">
              ...
              <details className="bg-white p-6 rounded-lg shadow-sm border border-slate-200 group">
                ...
                <p className="text-sm text-slate-600 mt-4 leading-relaxed">
                  ...
                  Wholly Obtained: Everything was grown/mined in India.
                  Substantial Transformation: Imported parts were used, but the final product has a different HSN Code and at least 35-40% Value Addition in India.
                </p>
              </details>
