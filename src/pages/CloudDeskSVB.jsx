...
const FAQS = [
  ...
  {
    question:
      "Does every related-party import automatically lead to valuation loading?",
    answer:
      ...
      <section id="about" class="py-20 bg-white">
        <div class="container mx-auto px-4 max-w-5xl">
          ...
          <div class="prose lg:prose-lg mx-auto text-slate-600 text-justify">
            <p class="mb-4">
              The <strong>Special Valuation Branch (SVB)</strong> is a
              specialized unit of the Customs Department that investigates
              import cases involving transactions between "related parties"
              under Rule 2(1) of the Customs Valuation (Determination of Value
              of Imported Goods) Rules, 2007.
            </p>

            <p class="mb-4">
              The objective is to determine if the relationship between the
              importer and the supplier has influenced the transaction price. If
              the price is deemed artificially low, SVB orders a **Valuation
              Loading**, meaning the importer pays duty on a higher value, often
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-white p-6 rounded-lg shadow border-t-4 border-brand-600">
              ...
              <p className="text-sm text-slate-600">
                One party directly or indirectly controls the other (e.g.,
                Parent / Subsidiary).
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow border-t-4 border-brand-600">
              ...
              <p className="text-sm text-slate-600">
                Importer and supplier share common directors, officers, or are
            ...
            <div className="bg-white p-6 rounded-lg shadow border-t-4 border-brand-600">
              ...
              <p className="text-sm text-slate-600">
                Supplier acts as the sole agent, distributor, or concessionaire
                of the importer.
              </p>
            </div>
          </div>
          ...
          <div className="mt-12 bg-white rounded-xl shadow-lg p-8 border border-slate-200">
            ...
            <p className="text-slate-600 mb-4">
              ...
              consignment until the Final Order is issued (usually 12–18
              months).
            </p>

            <p className="text-sm text-red-600 font-bold">
              This blocked capital directly impacts cash flow. Fast-tracking the
              SVB process is not optional — it’s critical.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="relative grid md:grid-cols-5 gap-8">
            ...
            <div className="text-center relative z-10">
              ...
              <p className="text-sm text-slate-400">
                Case is referred by the port to the jurisdictional SVB (Mumbai /
                Delhi / Chennai).
              </p>
            </div>
            ...
            <div className="text-center relative z-10">
              ...
              <p className="text-sm text-slate-400">
                Submission of 30+ mandatory documents and detailed replies to
                the SVB Questionnaire.
              </p>
            </div>
            ...
            <div className="text-center relative z-10">
              ...
              <p className="text-sm text-slate-400">
                SVB issues the Final Order accepting the price or imposing
                loading / penalty.
              </p>
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              <p className="text-slate-600 mb-8 leading-relaxed">
                Even after the initial SVB investigation, compliance does not
                end. The Final Order remains subject to annual review by Customs
                authorities.
              </p>
              ...
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <span className="text-sm text-slate-500">
                      Mandatory yearly submission of financial data to
                      demonstrate that transaction pricing remains competitive.
                    </span>
                  </div>
                </li>
                ...
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <span className="text-sm text-slate-500">
                      We align your P&amp;L, Balance Sheet, and transfer pricing
                      policies with the declared import value.
                    </span>
                  </div>
                </li>
                ...
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <span className="text-sm text-slate-500">
                      Complete liaison for EDD (Extra Duty Deposit) waiver and
                      refund upon final closure.
                    </span>
                  </div>
                </li>
              </ul>
        ...
        <div className="container mx-auto px-4 max-w-5xl">
          <div className="text-center mb-12">
            ...
            <p className="text-slate-500">
              SVB is where 'Accountancy' meets 'Customs Law.' CloudDesk ensures
              your global transfer pricing stands up to local scrutiny.
            </p>
          </div>
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="flex gap-4 p-6 bg-slate-50 rounded-xl border border-slate-100">
              ...
              <div>
                ...
                <p className="text-sm text-slate-600 leading-relaxed">
                  The <strong>SVB </strong>process starts with a massive
                  questionnaire <strong>(Annexure A).</strong>
                  One wrong answer about{" "}
                  <strong>"Royalty" or "License Fees" </strong>can trigger a
                  100% investigation.
                  <strong>CloudDesk </strong>performs a Financial Review of your
                  Inter-Company Agreements to ensure your answers are consistent
                  with your <strong>Income Tax (TP)</strong> filings and Customs
                  laws.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-4 p-6 bg-slate-50 rounded-xl border border-slate-100">
              ...
              <div>
                ...
                <p className="text-sm text-slate-600 leading-relaxed">
                  Historically,{" "}
                  <strong>
                    SVB cases led to a 1%–5% Extra Duty Deposit (EDD)
                  </strong>{" "}
                  on every shipment while the case was pending.
                  <strong>CloudDesk’s "Early-Resolution" </strong>Strategy aims
                  to get a "No-EDD" order by providing a robust data set at the
                  time of <strong>registration, </strong>keeping your working
                  capital free.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-4 p-6 bg-slate-50 rounded-xl border border-slate-100">
              ...
              <div>
                ...
                <p className="text-sm text-slate-600 leading-relaxed">
                  Customs officers often look for contradictions between your
                  Income Tax TP Report and your Customs Valuation.
                  <strong>CloudDesk’s </strong>experts align these two
                  perspectives, creating a
                  <strong> "Unified Valuation Defense" </strong>that proves your{" "}
                  <strong>"Arm’s Length" </strong>price is valid for both
                  departments.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-4 p-6 bg-slate-50 rounded-xl border border-slate-100">
              ...
              <div>
                ...
                <p className="text-sm text-slate-600 leading-relaxed">
                  ...
                  You must file a Renewal Declaration every year/period.{" "}
                  <strong>CloudDesk’s </strong>Compliance Clock tracks your SVB
                  order expiry and files the necessary{" "}
                  <strong>"No Change" </strong>declarations to ensure your
                  imports continue under{" "}
                  <strong>"Final Assessment" status.</strong>
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <details className="bg-white p-6 rounded-lg shadow-sm border border-slate-200 group">
              ...
              <p className="text-sm text-slate-600 mt-4 leading-relaxed">
                Any importer who is "Related" to their foreign supplier under
                Rule 2(2) of the Customs Valuation Rules. This includes: (1)
                Subsidiaries/Parent companies, (2) Companies with common
                Directors, (3) Partners in business, or (4) If one company
                controls the other.
              </p>
            </details>
            ...
            <details className="bg-white p-6 rounded-lg shadow-sm border border-slate-200 group">
              <summary className="font-bold text-slate-800 cursor-pointer flex justify-between items-center">
                Is SVB registration mandatory for every related party
                transaction?
                <ChevronDown
                  size={20}
                  className="text-brand-500 transition-transform group-open:rotate-180"
              ...
              <p className="text-sm text-slate-600 mt-4 leading-relaxed">
                No. You don't need SVB if: (1) The import is a one-time gift,
                (2) The total value is small (as per local limits), or (3) The
                goods are duty-free and there's no incentive involved. CloudDesk
                provides an SVB Applicability Test to see if you can skip the
                process entirely.
              </p>
            </details>
            ...
            <details className="bg-white p-6 rounded-lg shadow-sm border border-slate-200 group">
              ...
              <p className="text-sm text-slate-600 mt-4 leading-relaxed">
                This is the current governing law that simplified the SVB
                process. It replaced the old, endless investigations with a
                time-bound registration and a "Risk-Based" approach to
                investigation.
              </p>
            </details>
            ...
            <details className="bg-white p-6 rounded-lg shadow-sm border border-slate-200 group">
              ...
              <p className="text-sm text-slate-600 mt-4 leading-relaxed">
                "• Annexure A: The initial questionnaire you file at the port of
                entry to register your relationship. • Annexure B: The detailed
                follow-up questionnaire filed if the SVB decides a full
            ...
            <details className="bg-white p-6 rounded-lg shadow-sm border border-slate-200 group">
              ...
              <p className="text-sm text-slate-600 mt-4 leading-relaxed">
                Legally, the SVB should finalize the investigation within 4 to 6
                months from the date of receiving all documents. However,
                without proactive follow-up (which CloudDesk provides), these
                cases can drag on for a year.
              </p>
            </details>
            ...
            <details className="bg-white p-6 rounded-lg shadow-sm border border-slate-200 group">
              ...
              <p className="text-sm text-slate-600 mt-4 leading-relaxed">
                Until the SVB issues a final "Order," your Bill of Entry is
                assessed "Provisionally." This means the duty you pay is not
                final, and you may be asked to pay an Extra Duty Deposit (EDD).
                CloudDesk works to minimize or eliminate this EDD.
              </p>
            </details>
            ...
            <details className="bg-white p-6 rounded-lg shadow-sm border border-slate-200 group">
              ...
              <p className="text-sm text-slate-600 mt-4 leading-relaxed">
                There is no "Registration Fee" charged by Customs. The costs are
                purely professional (for experts like CloudDesk) and potential
                EDD if your case is deemed high-risk.
              </p>
            </details>
            ...
            <details className="bg-white p-6 rounded-lg shadow-sm border border-slate-200 group">
              ...
              <p className="text-sm text-slate-600 mt-4 leading-relaxed">
                If you sign a new agreement with your parent company or change
                your transfer pricing formula, you must inform the SVB
                immediately. Failure to do so can lead to heavy penalties and a
                retrospective duty demand
              </p>
            </details>
          </div>
        </div>
