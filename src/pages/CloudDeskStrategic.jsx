      ...
      <header className="relative bg-slate-900 text-white pt-40 pb-32 overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10 text-center max-w-5xl">
          ...
          <h1 className="text-5xl md:text-7xl font-extrabold leading-tight mb-8 tracking-tight">
            Compliance isn't just <br className="hidden md:block" />
          ...
          <p className="text-xl text-slate-400 mb-12 max-w-2xl mx-auto leading-relaxed font-light">
            We replace generic CHAs with specialist auditors. Using our
            proprietary <strong>CloudDesk SaaS</strong>, we identify stuck
            incentives, automate daily filings, and bulletproof your AEO status.
          </p>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-16">
            <div className="max-w-2xl">
              ...
              <p className="text-lg text-slate-500">
                Most exporters lose 2-5% of their margin due to unredeemed
                licenses and expired scripts. We audit your last 3 years of
                shipping bills to recover this lost cash.
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white border border-slate-200 rounded-2xl p-8 hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 group">
              ...
              <ul className="text-sm text-slate-500 space-y-2 mb-6 border-t border-slate-100 pt-4">
                ...
                <a
                  ...
                  className="flex items-center text-slate-600 text-sm hover:text-indigo-600 transition"
                >
                  <span className="w-1.5 h-1.5 bg-teal-500 rounded-full mr-2 shrink-0" />
                  EOP Extension
                </a>
                {/* <li className="flex items-center">
                  <span className="w-1.5 h-1.5 bg-teal-500 rounded-full mr-2"></span>
            ...
            <div className="bg-white border border-slate-200 rounded-2xl p-8 hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 group">
              ...
              <p className="text-slate-500 text-sm mb-6 leading-relaxed">
                Don't settle for low All Industry Rates (AIR). We calculate
                actual duties paid on inputs and fix a special higher rate for
                you.
              </p>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-16 max-w-3xl mx-auto">
            ...
            <p className="text-lg text-slate-400">
              We manage the specialized licenses that generic CHAs fail to
              handle. Zero demurrage guarantee for technical imports.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="bg-slate-800/50 backdrop-blur border border-slate-700 p-6 rounded-xl hover:bg-slate-800 transition group">
              ...
              <ul className="space-y-2 text-sm text-slate-400 mb-4">
                ...
                <li>
                  <Link
                    to="/services/fertiliser-import-license"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="hover:text-white transition"
                  >
                ...
                <li>
                  <Link
                    to="/services/defence-exim-license"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="hover:text-white transition"
                  >
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            <div className="p-6 border border-slate-200 rounded-xl hover:border-teal-500 transition hover:shadow-lg">
              ...
              >
                Import of Goods at Concessional Rate. Essential for
                manufacturers to reduce duty burden on raw materials.
              </a>
                {/* Import of Goods at Concessional Rate. Essential for
                manufacturers to reduce duty burden on raw materials. */}
              </p>
            ...
            <div className="p-6 border border-slate-200 rounded-xl hover:border-teal-500 transition hover:shadow-lg">
              ...
              <ul className="text-sm text-slate-600 space-y-1 mb-4">
                ...
                <li>
                  <a
                    href="/services/un-iip-certification"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="hover:text-blue-600 transition"
                  >
      ...
      <section className="py-16 bg-slate-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-5xl mx-auto">
            ...
            >
              <div className="font-bold text-slate-800">LMPC Registration</div>
            ...
            <a
              ...
              className="bg-white p-4 rounded-lg shadow-sm border border-slate-200 text-center hover:border-indigo-500 transition block"
            >
              <div className="font-bold text-slate-800">Free Sale Cert</div>
              <div className="text-xs text-slate-500">
            ...
            <a
              ...
              className="bg-white p-4 rounded-lg shadow-sm border border-slate-200 text-center hover:border-indigo-500 transition block"
            >
              <div className="font-bold text-slate-800">No Due Cert</div>
              <div className="text-xs text-slate-500">Govt. Dues Clearance</div>
            </a>
            ...
            <a
              ...
              className="bg-white p-4 rounded-lg shadow-sm border border-slate-200 text-center hover:border-indigo-500 transition block"
            >
              <div className="font-bold text-slate-800">No Incentive Cert</div>
              <div className="text-xs text-slate-500">Avoid Double Dipping</div>
            </a>
          </div>
        </div>
      </section>
      ...
      <section id="logistics" className="py-20 bg-slate-100">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-6xl mx-auto">
            ...
            <div className="bg-white p-4 rounded-lg shadow-sm border border-slate-200 text-center hover:border-teal-500 transition">
              <div className="font-bold text-slate-800">
                <div className="font-bold text-slate-800">CHA Services</div>
              </div>
            ...
            <div className="bg-white p-4 rounded-lg shadow-sm border border-slate-200 text-center hover:border-teal-500 transition">
              <div className="font-bold text-slate-800">
                <div className="font-bold text-slate-800">Warehousing</div>
              </div>
            ...
            <div className="bg-white p-4 rounded-lg shadow-sm border border-slate-200 text-center hover:border-teal-500 transition">
              <div className="font-bold text-slate-800">
                <div className="font-bold text-slate-800">Factory Stuffing</div>
              </div>
            ...
            <div className="bg-white p-4 rounded-lg shadow-sm border border-slate-200 text-center hover:border-teal-500 transition">
              <div className="font-bold text-slate-800">
                <div className="font-bold text-slate-800">Inland Transport</div>
              </div>
            ...
            <div className="bg-white p-4 rounded-lg shadow-sm border border-slate-200 text-center hover:border-teal-500 transition">
              <div className="font-bold text-slate-800">
                <div className="font-bold text-slate-800">DPD Registration</div>
              </div>

              <div className="text-xs text-slate-500">
                <a
                  href="/services/dpd-registration/"
                  target="_blank"
                  rel="noopener noreferrer"
                >
            ...
            <div className="bg-white p-4 rounded-lg shadow-sm border border-slate-200 text-center hover:border-teal-500 transition">
              <div className="font-bold text-slate-800">
                <div className="font-bold text-slate-800">Project Cargo</div>
              </div>
            ...
            <div className="bg-white p-4 rounded-lg shadow-sm border border-slate-200 text-center hover:border-teal-500 transition">
              <div className="font-bold text-slate-800">
                <div className="font-bold text-slate-800">Marine Insurance</div>
              </div>
