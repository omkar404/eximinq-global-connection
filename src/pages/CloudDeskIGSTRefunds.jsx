  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Resolve IGST export refund errors like SB005, SB006, PFMS rejection and invoice mismatch. Professional GST and ICEGATE refund recovery support."
        />

        <link
          rel="canonical"
          href="https://eximinq.in/services/igst-refund"
        />

        <meta property="og:title" content="IGST Refund Consultancy in India" />
        <meta
          property="og:description"
          content="Expert support for stuck IGST refunds, GST-Shipping Bill mismatch correction and officer interface resolution."
        />
        <meta
          property="og:url"
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "@graph": [
              ...
              {
                "@type": "Service",
                "name": "IGST Refund Recovery",
                "serviceType": "GST Export Refund",
                "description":
                  "Professional assistance for stuck IGST refunds including SB005, SB006, PFMS errors and shipping bill mismatch correction.",
                "provider": {
                  "@type": "Organization",
              ...
              },
              {
                ...
                "mainEntity": [
                  {
                    "@type": "Question",
                    "name": "What if I filed GSTR-3B but refund is not received?",
                    "acceptedAnswer": {
                      "@type": "Answer",
                      "text": "You must verify whether GSTR-1 data was transmitted to ICEGATE. Check the Track Status of IGST Refund section on the GST portal."
                    }
                  },
                  {
                    "@type": "Question",
                    "name": "What is error code SB005?",
                    "acceptedAnswer": {
                      "@type": "Answer",
                      "text": "SB005 indicates invoice number mismatch between GST return and Shipping Bill data."
                    }
                  },
                  {
                    "@type": "Question",
                    "name": "What is the time limit for claiming IGST refund?",
                    "acceptedAnswer": {
                      "@type": "Answer",
                      "text": "There is no separate time limit since the Shipping Bill acts as the refund application, but mismatch corrections should ideally be resolved within two years."
                    }
                  }
                ]
              }
